...
func (ptr *QUndoStack) ConnectTimerEvent(f func(event *core.QTimerEvent)) {
	defer qt.Recovering("connect QUndoStack::timerEvent")
...
func (ptr *QUndoStack) DisconnectTimerEvent() {
	defer qt.Recovering("disconnect QUndoStack::timerEvent")
...
func (ptr *QUndoStack) ConnectChildEvent(f func(event *core.QChildEvent)) {
	defer qt.Recovering("connect QUndoStack::childEvent")
...
func (ptr *QUndoStack) DisconnectChildEvent() {
	defer qt.Recovering("disconnect QUndoStack::childEvent")
...
func (ptr *QUndoStack) ConnectCustomEvent(f func(event *core.QEvent)) {
	defer qt.Recovering("connect QUndoStack::customEvent")
...
func (ptr *QUndoStack) DisconnectCustomEvent() {
	defer qt.Recovering("disconnect QUndoStack::customEvent")
