...
func callbackQWizardPageFocusInEvent(ptrName *C.char, event unsafe.Pointer) bool {
...
func callbackQWizardPageChangeEvent(ptrName *C.char, event unsafe.Pointer) bool {
