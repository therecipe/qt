...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi1/lib -lQt5Widgets -lQt5Gui -lQt5Core -lGLESv2 -lpthread
*/
import "C"
