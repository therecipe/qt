...
func (ptr *QStyle) ConnectTimerEvent(f func(event *core.QTimerEvent)) {
	defer qt.Recovering("connect QStyle::timerEvent")
...
func (ptr *QStyle) DisconnectTimerEvent() {
	defer qt.Recovering("disconnect QStyle::timerEvent")
...
func (ptr *QStyle) ConnectChildEvent(f func(event *core.QChildEvent)) {
	defer qt.Recovering("connect QStyle::childEvent")
...
func (ptr *QStyle) DisconnectChildEvent() {
	defer qt.Recovering("disconnect QStyle::childEvent")
...
func (ptr *QStyle) ConnectCustomEvent(f func(event *core.QEvent)) {
	defer qt.Recovering("connect QStyle::customEvent")
...
func (ptr *QStyle) DisconnectCustomEvent() {
	defer qt.Recovering("disconnect QStyle::customEvent")
