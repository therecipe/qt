...
public:
	...
	void connectNotify(const QMetaMethod & sign) { callbackQMaskGenerator_ConnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
	...
	void disconnectNotify(const QMetaMethod & sign) { callbackQMaskGenerator_DisconnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
...
public:
	...
	void connectNotify(const QMetaMethod & sign) { callbackQWebSocket_ConnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
	...
	void disconnectNotify(const QMetaMethod & sign) { callbackQWebSocket_DisconnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
...
public:
	...
	void Signal_PeerVerifyError(const QSslError & error) { callbackQWebSocketServer_PeerVerifyError(this, this->objectName().toUtf8().data(), new QSslError(error)); };
	...
	void connectNotify(const QMetaMethod & sign) { callbackQWebSocketServer_ConnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
	...
	void disconnectNotify(const QMetaMethod & sign) { callbackQWebSocketServer_DisconnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
