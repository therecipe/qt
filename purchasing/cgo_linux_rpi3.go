...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_PURCHASING_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtPurchasing
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi3/lib -lQt5Core -lQt5Purchasing -lGLESv2 -lpthread
*/
import "C"
