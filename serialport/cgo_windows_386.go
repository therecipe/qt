...
#cgo CPPFLAGS: -IC:/Qt/Qt5.6.0/5.6/mingw49_32/include/QtCore -IC:/Qt/Qt5.6.0/5.6/mingw49_32/include/QtSerialPort

#cgo LDFLAGS: -Wl,-s -Wl,-subsystem,windows -mthreads -Wl,--allow-multiple-definition
#cgo LDFLAGS: -LC:/Qt/Qt5.6.0/5.6/mingw49_32/lib -lQt5Core -lQt5SerialPort -lmingw32 -lqtmain -lshell32
*/
import "C"
