...
func callbackQVideoWidgetFocusInEvent(ptrName *C.char, event unsafe.Pointer) bool {
...
func callbackQVideoWidgetChangeEvent(ptrName *C.char, event unsafe.Pointer) bool {
