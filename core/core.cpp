...
public:
	...
	bool atEnd() const { return callbackQProcess_AtEnd(const_cast<MyQProcess*>(this), this->objectName().toUtf8().data()) != 0; };
	qint64 bytesAvailable() const { return static_cast<long long>(callbackQProcess_BytesAvailable(const_cast<MyQProcess*>(this), this->objectName().toUtf8().data())); };
	...
	bool open(QIODevice::OpenMode mode) { return callbackQProcess_Open(this, this->objectName().toUtf8().data(), mode) != 0; };
	void Signal_ReadyReadStandardError() { callbackQProcess_ReadyReadStandardError(this, this->objectName().toUtf8().data()); };
	void Signal_ReadyReadStandardOutput() { callbackQProcess_ReadyReadStandardOutput(this, this->objectName().toUtf8().data()); };
	void setupChildProcess() { callbackQProcess_SetupChildProcess(this, this->objectName().toUtf8().data()); };
	void Signal_Started() { callbackQProcess_Started(this, this->objectName().toUtf8().data()); };
	void Signal_StateChanged(QProcess::ProcessState newState) { callbackQProcess_StateChanged(this, this->objectName().toUtf8().data(), newState); };
	void terminate() { callbackQProcess_Terminate(this, this->objectName().toUtf8().data()); };
	bool waitForBytesWritten(int msecs) { return callbackQProcess_WaitForBytesWritten(this, this->objectName().toUtf8().data(), msecs) != 0; };
	bool waitForReadyRead(int msecs) { return callbackQProcess_WaitForReadyRead(this, this->objectName().toUtf8().data(), msecs) != 0; };
	qint64 writeData(const char * data, qint64 len) { return static_cast<long long>(callbackQProcess_WriteData(this, this->objectName().toUtf8().data(), QString(data).toUtf8().data(), static_cast<long long>(len))); };
	qint64 pos() const { return static_cast<long long>(callbackQProcess_Pos(const_cast<MyQProcess*>(this), this->objectName().toUtf8().data())); };
	qint64 readLineData(char * data, qint64 maxSize) { return static_cast<long long>(callbackQProcess_ReadLineData(this, this->objectName().toUtf8().data(), QString(data).toUtf8().data(), static_cast<long long>(maxSize))); };
	bool reset() { return callbackQProcess_Reset(this, this->objectName().toUtf8().data()) != 0; };
	bool seek(qint64 pos) { return callbackQProcess_Seek(this, this->objectName().toUtf8().data(), static_cast<long long>(pos)) != 0; };
	qint64 size() const { return static_cast<long long>(callbackQProcess_Size(const_cast<MyQProcess*>(this), this->objectName().toUtf8().data())); };
	void timerEvent(QTimerEvent * event) { callbackQProcess_TimerEvent(this, this->objectName().toUtf8().data(), event); };
	void childEvent(QChildEvent * event) { callbackQProcess_ChildEvent(this, this->objectName().toUtf8().data(), event); };
	void connectNotify(const QMetaMethod & sign) { callbackQProcess_ConnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
	void customEvent(QEvent * event) { callbackQProcess_CustomEvent(this, this->objectName().toUtf8().data(), event); };
	void deleteLater() { callbackQProcess_DeleteLater(this, this->objectName().toUtf8().data()); };
	void disconnectNotify(const QMetaMethod & sign) { callbackQProcess_DisconnectNotify(this, this->objectName().toUtf8().data(), new QMetaMethod(sign)); };
	bool event(QEvent * e) { return callbackQProcess_Event(this, this->objectName().toUtf8().data(), e) != 0; };
	bool eventFilter(QObject * watched, QEvent * event) { return callbackQProcess_EventFilter(this, this->objectName().toUtf8().data(), watched, event) != 0; };
	const QMetaObject * metaObject() const { return static_cast<QMetaObject*>(callbackQProcess_MetaObject(const_cast<MyQProcess*>(this), this->objectName().toUtf8().data())); };
};
...
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::bytesAvailable());
}
...
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::bytesToWrite());
}
...
char* QProcess_NativeArguments(void* ptr)
{
#ifdef Q_OS_WIN
	return static_cast<QProcess*>(ptr)->nativeArguments().toUtf8().data();
#else
	return "";
#endif
}
...
{
	return QString(static_cast<QProcess*>(ptr)->readAllStandardError()).toUtf8().data();
}

char* QProcess_ReadAllStandardOutput(void* ptr)
{
	return QString(static_cast<QProcess*>(ptr)->readAllStandardOutput()).toUtf8().data();
}
...
void QProcess_SetNativeArguments(void* ptr, char* arguments)
{
#ifdef Q_OS_WIN
	static_cast<QProcess*>(ptr)->setNativeArguments(QString(arguments));
#endif
}
...
void QProcess_SetProcessState(void* ptr, int state)
{
...
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::writeData(const_cast<const char*>(data), static_cast<long long>(len)));
}
...
long long QProcess_Pos(void* ptr)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->pos());
}

long long QProcess_PosDefault(void* ptr)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::pos());
}

long long QProcess_ReadLineData(void* ptr, char* data, long long maxSize)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->readLineData(data, static_cast<long long>(maxSize)));
}

long long QProcess_ReadLineDataDefault(void* ptr, char* data, long long maxSize)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::readLineData(data, static_cast<long long>(maxSize)));
}

int QProcess_Reset(void* ptr)
{
	return static_cast<QProcess*>(ptr)->reset();
}

int QProcess_ResetDefault(void* ptr)
{
	return static_cast<QProcess*>(ptr)->QProcess::reset();
}

int QProcess_Seek(void* ptr, long long pos)
{
	return static_cast<QProcess*>(ptr)->seek(static_cast<long long>(pos));
}

int QProcess_SeekDefault(void* ptr, long long pos)
{
	return static_cast<QProcess*>(ptr)->QProcess::seek(static_cast<long long>(pos));
}

long long QProcess_Size(void* ptr)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->size());
}

long long QProcess_SizeDefault(void* ptr)
{
	return static_cast<long long>(static_cast<QProcess*>(ptr)->QProcess::size());
}

void QProcess_TimerEvent(void* ptr, void* event)
{
	static_cast<QProcess*>(ptr)->timerEvent(static_cast<QTimerEvent*>(event));
}
...
{
	static_cast<QProcess*>(ptr)->childEvent(static_cast<QChildEvent*>(event));
}
...
void QProcess_ConnectNotify(void* ptr, void* sign)
{
	static_cast<QProcess*>(ptr)->connectNotify(*static_cast<QMetaMethod*>(sign));
}

void QProcess_ConnectNotifyDefault(void* ptr, void* sign)
{
...
{
	static_cast<QProcess*>(ptr)->customEvent(static_cast<QEvent*>(event));
}
...
{
	return static_cast<QProcess*>(ptr)->event(static_cast<QEvent*>(e));
}

int QProcess_EventDefault(void* ptr, void* e)
{
	return static_cast<QProcess*>(ptr)->QProcess::event(static_cast<QEvent*>(e));
}

int QProcess_EventFilter(void* ptr, void* watched, void* event)
{
	return static_cast<QProcess*>(ptr)->eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
}

int QProcess_EventFilterDefault(void* ptr, void* watched, void* event)
{
	return static_cast<QProcess*>(ptr)->QProcess::eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
}

void* QProcess_MetaObject(void* ptr)
{
	return const_cast<QMetaObject*>(static_cast<QProcess*>(ptr)->metaObject());
}

void* QProcess_MetaObjectDefault(void* ptr)
{
...
void QProcessEnvironment_Insert(void* ptr, char* name, char* value)
{
	static_cast<QProcessEnvironment*>(ptr)->insert(QString(name), QString(value));
}
...
void QProcessEnvironment_Remove(void* ptr, char* name)
{
	static_cast<QProcessEnvironment*>(ptr)->remove(QString(name));
}
