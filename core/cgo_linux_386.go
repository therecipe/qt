...
#cgo CPPFLAGS: -I/usr/local/Qt5.5.1/5.5/gcc/include/QtWidgets -I/usr/local/Qt5.5.1/5.5/gcc/include/QtCore

#cgo LDFLAGS: -Wl,-O1 -Wl,-rpath,/usr/local/Qt5.5.1/5.5/gcc -Wl,-rpath,/usr/local/Qt5.5.1/5.5/gcc/lib
#cgo LDFLAGS: -L/usr/local/Qt5.5.1/5.5/gcc/lib -L/usr/lib -lQt5Widgets -lQt5Core -lpthread
*/
import "C"
