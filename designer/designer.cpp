...
public:
	...
	void initPainter(QPainter * painter) const { callbackQDesignerActionEditorInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
...
{
public:
	QList<QDesignerCustomWidgetInterface *> customWidgets() const { return ({ QList<QDesignerCustomWidgetInterface *>* tmpP = static_cast<QList<QDesignerCustomWidgetInterface *>*>(callbackQDesignerCustomWidgetCollectionInterface_CustomWidgets(const_cast<void*>(static_cast<const void*>(this)))); QList<QDesignerCustomWidgetInterface *> tmpV = *tmpP; tmpP->~QList(); free(tmpP); tmpV; }); };
...
{
	return ({QDesignerCustomWidgetInterface * tmp = static_cast<QList<QDesignerCustomWidgetInterface *>*>(ptr)->at(i); if (i == static_cast<QList<QDesignerCustomWidgetInterface *>*>(ptr)->size()-1) { static_cast<QList<QDesignerCustomWidgetInterface *>*>(ptr)->~QList(); free(ptr); }; tmp; });
}
...
public:
	...
	void initPainter(QPainter * painter) const { callbackQDesignerFormWindowInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
...
{
	static_cast<QDesignerFormWindowInterface*>(ptr)->setResourceFileSaveMode(static_cast<QDesignerFormWindowInterface::ResourceFileSaveMode>(behavior));
}
...
public:
	...
	void initPainter(QPainter * painter) const { callbackQDesignerObjectInspectorInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
...
public:
	...
	void initPainter(QPainter * painter) const { callbackQDesignerPropertyEditorInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
...
class MyQDesignerResourceBrowserInterface: public QDesignerResourceBrowserInterface
{
public:
	void actionEvent(QActionEvent * event) { callbackQDesignerResourceBrowserInterface_ActionEvent(this, event); };
	void changeEvent(QEvent * event) { callbackQDesignerResourceBrowserInterface_ChangeEvent(this, event); };
	bool close() { return callbackQDesignerResourceBrowserInterface_Close(this) != 0; };
	void closeEvent(QCloseEvent * event) { callbackQDesignerResourceBrowserInterface_CloseEvent(this, event); };
	void contextMenuEvent(QContextMenuEvent * event) { callbackQDesignerResourceBrowserInterface_ContextMenuEvent(this, event); };
	void Signal_CustomContextMenuRequested(const QPoint & pos) { callbackQDesignerResourceBrowserInterface_CustomContextMenuRequested(this, const_cast<QPoint*>(&pos)); };
	void dragEnterEvent(QDragEnterEvent * event) { callbackQDesignerResourceBrowserInterface_DragEnterEvent(this, event); };
	void dragLeaveEvent(QDragLeaveEvent * event) { callbackQDesignerResourceBrowserInterface_DragLeaveEvent(this, event); };
	void dragMoveEvent(QDragMoveEvent * event) { callbackQDesignerResourceBrowserInterface_DragMoveEvent(this, event); };
	void dropEvent(QDropEvent * event) { callbackQDesignerResourceBrowserInterface_DropEvent(this, event); };
	void enterEvent(QEvent * event) { callbackQDesignerResourceBrowserInterface_EnterEvent(this, event); };
	bool event(QEvent * event) { return callbackQDesignerResourceBrowserInterface_Event(this, event) != 0; };
	void focusInEvent(QFocusEvent * event) { callbackQDesignerResourceBrowserInterface_FocusInEvent(this, event); };
	bool focusNextPrevChild(bool next) { return callbackQDesignerResourceBrowserInterface_FocusNextPrevChild(this, next) != 0; };
	void focusOutEvent(QFocusEvent * event) { callbackQDesignerResourceBrowserInterface_FocusOutEvent(this, event); };
	bool hasHeightForWidth() const { return callbackQDesignerResourceBrowserInterface_HasHeightForWidth(const_cast<void*>(static_cast<const void*>(this))) != 0; };
	int heightForWidth(int w) const { return callbackQDesignerResourceBrowserInterface_HeightForWidth(const_cast<void*>(static_cast<const void*>(this)), w); };
	void hide() { callbackQDesignerResourceBrowserInterface_Hide(this); };
	void hideEvent(QHideEvent * event) { callbackQDesignerResourceBrowserInterface_HideEvent(this, event); };
	void initPainter(QPainter * painter) const { callbackQDesignerResourceBrowserInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
	void inputMethodEvent(QInputMethodEvent * event) { callbackQDesignerResourceBrowserInterface_InputMethodEvent(this, event); };
	QVariant inputMethodQuery(Qt::InputMethodQuery query) const { return *static_cast<QVariant*>(callbackQDesignerResourceBrowserInterface_InputMethodQuery(const_cast<void*>(static_cast<const void*>(this)), query)); };
	void keyPressEvent(QKeyEvent * event) { callbackQDesignerResourceBrowserInterface_KeyPressEvent(this, event); };
	void keyReleaseEvent(QKeyEvent * event) { callbackQDesignerResourceBrowserInterface_KeyReleaseEvent(this, event); };
	void leaveEvent(QEvent * event) { callbackQDesignerResourceBrowserInterface_LeaveEvent(this, event); };
	void lower() { callbackQDesignerResourceBrowserInterface_Lower(this); };
	int metric(QPaintDevice::PaintDeviceMetric m) const { return callbackQDesignerResourceBrowserInterface_Metric(const_cast<void*>(static_cast<const void*>(this)), m); };
	QSize minimumSizeHint() const { return *static_cast<QSize*>(callbackQDesignerResourceBrowserInterface_MinimumSizeHint(const_cast<void*>(static_cast<const void*>(this)))); };
	void mouseDoubleClickEvent(QMouseEvent * event) { callbackQDesignerResourceBrowserInterface_MouseDoubleClickEvent(this, event); };
	void mouseMoveEvent(QMouseEvent * event) { callbackQDesignerResourceBrowserInterface_MouseMoveEvent(this, event); };
	void mousePressEvent(QMouseEvent * event) { callbackQDesignerResourceBrowserInterface_MousePressEvent(this, event); };
	void mouseReleaseEvent(QMouseEvent * event) { callbackQDesignerResourceBrowserInterface_MouseReleaseEvent(this, event); };
	void moveEvent(QMoveEvent * event) { callbackQDesignerResourceBrowserInterface_MoveEvent(this, event); };
	bool nativeEvent(const QByteArray & eventType, void * message, long * result) { return callbackQDesignerResourceBrowserInterface_NativeEvent(this, const_cast<QByteArray*>(&eventType), message, result) != 0; };
	QPaintEngine * paintEngine() const { return static_cast<QPaintEngine*>(callbackQDesignerResourceBrowserInterface_PaintEngine(const_cast<void*>(static_cast<const void*>(this)))); };
	void paintEvent(QPaintEvent * event) { callbackQDesignerResourceBrowserInterface_PaintEvent(this, event); };
	void raise() { callbackQDesignerResourceBrowserInterface_Raise(this); };
	void repaint() { callbackQDesignerResourceBrowserInterface_Repaint(this); };
	void resizeEvent(QResizeEvent * event) { callbackQDesignerResourceBrowserInterface_ResizeEvent(this, event); };
	void setDisabled(bool disable) { callbackQDesignerResourceBrowserInterface_SetDisabled(this, disable); };
	...
	void showMaximized() { callbackQDesignerResourceBrowserInterface_ShowMaximized(this); };
	void showMinimized() { callbackQDesignerResourceBrowserInterface_ShowMinimized(this); };
	void showNormal() { callbackQDesignerResourceBrowserInterface_ShowNormal(this); };
	QSize sizeHint() const { return *static_cast<QSize*>(callbackQDesignerResourceBrowserInterface_SizeHint(const_cast<void*>(static_cast<const void*>(this)))); };
	void tabletEvent(QTabletEvent * event) { callbackQDesignerResourceBrowserInterface_TabletEvent(this, event); };
	void update() { callbackQDesignerResourceBrowserInterface_Update(this); };
	...
	void deleteLater() { callbackQDesignerResourceBrowserInterface_DeleteLater(this); };
...
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::actionEvent(static_cast<QActionEvent*>(event));
}

void QDesignerResourceBrowserInterface_ChangeEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::changeEvent(static_cast<QEvent*>(event));
}

char QDesignerResourceBrowserInterface_CloseDefault(void* ptr)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::close();
}

void QDesignerResourceBrowserInterface_CloseEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::closeEvent(static_cast<QCloseEvent*>(event));
}

void QDesignerResourceBrowserInterface_ContextMenuEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::contextMenuEvent(static_cast<QContextMenuEvent*>(event));
}

void QDesignerResourceBrowserInterface_DragEnterEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::dragEnterEvent(static_cast<QDragEnterEvent*>(event));
}

void QDesignerResourceBrowserInterface_DragLeaveEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::dragLeaveEvent(static_cast<QDragLeaveEvent*>(event));
}

void QDesignerResourceBrowserInterface_DragMoveEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::dragMoveEvent(static_cast<QDragMoveEvent*>(event));
}

void QDesignerResourceBrowserInterface_DropEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::dropEvent(static_cast<QDropEvent*>(event));
}

void QDesignerResourceBrowserInterface_EnterEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::enterEvent(static_cast<QEvent*>(event));
}

char QDesignerResourceBrowserInterface_EventDefault(void* ptr, void* event)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::event(static_cast<QEvent*>(event));
}

void QDesignerResourceBrowserInterface_FocusInEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::focusInEvent(static_cast<QFocusEvent*>(event));
}

char QDesignerResourceBrowserInterface_FocusNextPrevChildDefault(void* ptr, char next)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::focusNextPrevChild(next != 0);
}

void QDesignerResourceBrowserInterface_FocusOutEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::focusOutEvent(static_cast<QFocusEvent*>(event));
}

char QDesignerResourceBrowserInterface_HasHeightForWidthDefault(void* ptr)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::hasHeightForWidth();
}

int QDesignerResourceBrowserInterface_HeightForWidthDefault(void* ptr, int w)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::heightForWidth(w);
}

void QDesignerResourceBrowserInterface_HideDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::hide();
}

void QDesignerResourceBrowserInterface_HideEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::hideEvent(static_cast<QHideEvent*>(event));
}

void QDesignerResourceBrowserInterface_InitPainterDefault(void* ptr, void* painter)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::initPainter(static_cast<QPainter*>(painter));
}

void QDesignerResourceBrowserInterface_InputMethodEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::inputMethodEvent(static_cast<QInputMethodEvent*>(event));
}

void* QDesignerResourceBrowserInterface_InputMethodQueryDefault(void* ptr, long long query)
{
		return new QVariant(static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::inputMethodQuery(static_cast<Qt::InputMethodQuery>(query)));
}

void QDesignerResourceBrowserInterface_KeyPressEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::keyPressEvent(static_cast<QKeyEvent*>(event));
}

void QDesignerResourceBrowserInterface_KeyReleaseEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::keyReleaseEvent(static_cast<QKeyEvent*>(event));
}

void QDesignerResourceBrowserInterface_LeaveEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::leaveEvent(static_cast<QEvent*>(event));
}

void QDesignerResourceBrowserInterface_LowerDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::lower();
}

int QDesignerResourceBrowserInterface_MetricDefault(void* ptr, long long m)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::metric(static_cast<QPaintDevice::PaintDeviceMetric>(m));
}

void* QDesignerResourceBrowserInterface_MinimumSizeHintDefault(void* ptr)
{
		return ({ QSize tmpValue = static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::minimumSizeHint(); new QSize(tmpValue.width(), tmpValue.height()); });
}

void QDesignerResourceBrowserInterface_MouseDoubleClickEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::mouseDoubleClickEvent(static_cast<QMouseEvent*>(event));
}

void QDesignerResourceBrowserInterface_MouseMoveEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::mouseMoveEvent(static_cast<QMouseEvent*>(event));
}

void QDesignerResourceBrowserInterface_MousePressEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::mousePressEvent(static_cast<QMouseEvent*>(event));
}

void QDesignerResourceBrowserInterface_MouseReleaseEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::mouseReleaseEvent(static_cast<QMouseEvent*>(event));
}

void QDesignerResourceBrowserInterface_MoveEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::moveEvent(static_cast<QMoveEvent*>(event));
}

char QDesignerResourceBrowserInterface_NativeEventDefault(void* ptr, void* eventType, void* message, long* result)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::nativeEvent(*static_cast<QByteArray*>(eventType), message, result);
}

void* QDesignerResourceBrowserInterface_PaintEngineDefault(void* ptr)
{
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::paintEngine();
}

void QDesignerResourceBrowserInterface_PaintEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::paintEvent(static_cast<QPaintEvent*>(event));
}

void QDesignerResourceBrowserInterface_RaiseDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::raise();
}

void QDesignerResourceBrowserInterface_RepaintDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::repaint();
}

void QDesignerResourceBrowserInterface_ResizeEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::resizeEvent(static_cast<QResizeEvent*>(event));
}

void QDesignerResourceBrowserInterface_SetDisabledDefault(void* ptr, char disable)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setDisabled(disable != 0);
}

void QDesignerResourceBrowserInterface_SetEnabledDefault(void* ptr, char vbo)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setEnabled(vbo != 0);
}

void QDesignerResourceBrowserInterface_SetFocus2Default(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setFocus();
}

void QDesignerResourceBrowserInterface_SetHiddenDefault(void* ptr, char hidden)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setHidden(hidden != 0);
}

void QDesignerResourceBrowserInterface_SetStyleSheetDefault(void* ptr, struct QtDesigner_PackedString styleSheet)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setStyleSheet(QString::fromUtf8(styleSheet.data, styleSheet.len));
}

void QDesignerResourceBrowserInterface_SetVisibleDefault(void* ptr, char visible)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setVisible(visible != 0);
}

void QDesignerResourceBrowserInterface_SetWindowModifiedDefault(void* ptr, char vbo)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setWindowModified(vbo != 0);
}

void QDesignerResourceBrowserInterface_SetWindowTitleDefault(void* ptr, struct QtDesigner_PackedString vqs)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::setWindowTitle(QString::fromUtf8(vqs.data, vqs.len));
}

void QDesignerResourceBrowserInterface_ShowDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::show();
}

void QDesignerResourceBrowserInterface_ShowEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::showEvent(static_cast<QShowEvent*>(event));
}

void QDesignerResourceBrowserInterface_ShowFullScreenDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::showFullScreen();
}

void QDesignerResourceBrowserInterface_ShowMaximizedDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::showMaximized();
}

void QDesignerResourceBrowserInterface_ShowMinimizedDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::showMinimized();
}

void QDesignerResourceBrowserInterface_ShowNormalDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::showNormal();
}

void* QDesignerResourceBrowserInterface_SizeHintDefault(void* ptr)
{
		return ({ QSize tmpValue = static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::sizeHint(); new QSize(tmpValue.width(), tmpValue.height()); });
}

void QDesignerResourceBrowserInterface_TabletEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::tabletEvent(static_cast<QTabletEvent*>(event));
}

void QDesignerResourceBrowserInterface_UpdateDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::update();
}

void QDesignerResourceBrowserInterface_UpdateMicroFocusDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::updateMicroFocus();
}

void QDesignerResourceBrowserInterface_WheelEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::wheelEvent(static_cast<QWheelEvent*>(event));
}

void QDesignerResourceBrowserInterface_ChildEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::childEvent(static_cast<QChildEvent*>(event));
}

void QDesignerResourceBrowserInterface_ConnectNotifyDefault(void* ptr, void* sign)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::connectNotify(*static_cast<QMetaMethod*>(sign));
}

void QDesignerResourceBrowserInterface_CustomEventDefault(void* ptr, void* event)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::customEvent(static_cast<QEvent*>(event));
}

void QDesignerResourceBrowserInterface_DeleteLaterDefault(void* ptr)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::deleteLater();
}

void QDesignerResourceBrowserInterface_DisconnectNotifyDefault(void* ptr, void* sign)
{
		static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::disconnectNotify(*static_cast<QMetaMethod*>(sign));
}

char QDesignerResourceBrowserInterface_EventFilterDefault(void* ptr, void* watched, void* event)
{
	if (dynamic_cast<QExtensionFactory*>(static_cast<QObject*>(watched))) {
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::eventFilter(static_cast<QExtensionFactory*>(watched), static_cast<QEvent*>(event));
	} else if (dynamic_cast<QExtensionManager*>(static_cast<QObject*>(watched))) {
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::eventFilter(static_cast<QExtensionManager*>(watched), static_cast<QEvent*>(event));
	} else {
		return static_cast<QDesignerResourceBrowserInterface*>(ptr)->QDesignerResourceBrowserInterface::eventFilter(static_cast<QObject*>(watched), static_cast<QEvent*>(event));
	}
}
...
public:
	...
	QList<QAction *> taskActions() const { return ({ QList<QAction *>* tmpP = static_cast<QList<QAction *>*>(callbackQDesignerTaskMenuExtension_TaskActions(const_cast<void*>(static_cast<const void*>(this)))); QList<QAction *> tmpV = *tmpP; tmpP->~QList(); free(tmpP); tmpV; }); };
...
public:
	...
	void initPainter(QPainter * painter) const { callbackQDesignerWidgetBoxInterface_InitPainter(const_cast<void*>(static_cast<const void*>(this)), painter); };
