...
struct QtSvg_PackedString QGraphicsSvgItem_QGraphicsSvgItem_Tr(char* s, char* c, int n)
{
...
struct QtSvg_PackedString QSvgRenderer_QSvgRenderer_Tr(char* s, char* c, int n)
{
