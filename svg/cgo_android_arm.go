...
#cgo CPPFLAGS: -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtSvg -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtWidgets -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtGui -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtCore
...
#cgo LDFLAGS: -L/opt/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a -L/opt/android-ndk/platforms/android-9/arch-arm//usr/lib -L/usr/local/Qt5.5.1/5.5/android_armv7/lib -L/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a -L/opt/android/ndk/platforms/android-9/arch-arm//usr/lib -lQt5Svg -lQt5Widgets -lQt5Gui -lQt5Core -lGLESv2 -lgnustl_shared -llog -lz -lm -ldl -lc -lgcc
*/
import "C"
