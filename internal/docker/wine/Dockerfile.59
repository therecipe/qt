...
RUN QT=qt-opensource-windows-x86-5.9.6.exe && curl -sL --retry 10 --retry-delay 10 -O https://download.qt.io/official_releases/qt/5.9/5.9.6/$QT \
...
ENV GOPATH C:\\gopath
ENV WINEDEBUG -all
ENV WINEPATH C:\\Qt\\Qt5.9.6\\Tools\\mingw530_32\\bin;C:\\go\\bin
