...
func Update() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/dev-drprasad/qt/cmd/..."), "run \"go clean cmd\"")
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/dev-drprasad/qt/internal/..."), "run \"go clean internal\"")
...
func Upgrade() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/dev-drprasad/qt/..."), "run \"go clean\"")
	utils.RemoveAll(utils.GoQtPkgPath())

	utils.RunCmd(exec.Command("go", "get", "-v", "-d", "github.com/dev-drprasad/qt/cmd/..."), "run \"go get\"")
