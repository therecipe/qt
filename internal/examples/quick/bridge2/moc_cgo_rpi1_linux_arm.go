...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi1/lib -lQt5Core -lGLESv2 -lpthread
*/
import "C"
