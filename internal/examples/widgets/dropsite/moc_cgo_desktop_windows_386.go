...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/mingw53_32/include/QtCore -I/usr/local/Qt5.7.0/5.7/mingw53_32/include/QtGui -I/usr/local/Qt5.7.0/5.7/mingw53_32/include/QtWidgets

#cgo LDFLAGS: -Wl,-s -Wl,-subsystem,windows -mthreads -Wl,--allow-multiple-definition
#cgo LDFLAGS: -L/usr/local/Qt5.7.0/5.7/mingw53_32/lib -lQt5Core -lQt5Gui -lQt5Widgets -lmingw32 -lqtmain -lshell32
*/
import "C"
