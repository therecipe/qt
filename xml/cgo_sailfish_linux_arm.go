...
#cgo CXXFLAGS: -DQT_NO_DEBUG -DQT_XML_LIB -DQT_XMLPATTERNS_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtXml -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtXmlPatterns -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtCore
...
#cgo LDFLAGS: -rdynamic -L/srv/mer/targets/SailfishOS-armv7hl/usr/lib -L/srv/mer/targets/SailfishOS-armv7hl/lib -lsailfishapp -lmdeclarativecache5 -lQt5Xml -lQt5XmlPatterns -lQt5Core -lGLESv2 -lpthread
*/
import "C"
