...
func (ptr *QDomAttr) SetValue(v string) {
	if ptr.Pointer() != nil {
		...
		C.QDomAttr_SetValue(ptr.Pointer(), C.struct_QtXml_PackedString{vC, C.longlong(len(v))})
	}
}
...
func (ptr *QDomCharacterData) AppendData(arg string) {
	if ptr.Pointer() != nil {
		...
		C.QDomCharacterData_AppendData(ptr.Pointer(), C.struct_QtXml_PackedString{argC, C.longlong(len(arg))})
	}
}
...
func (ptr *QDomCharacterData) InsertData(offset uint, arg string) {
	if ptr.Pointer() != nil {
		...
		C.QDomCharacterData_InsertData(ptr.Pointer(), C.ulong(uint32(offset)), C.struct_QtXml_PackedString{argC, C.longlong(len(arg))})
	}
}
...
func (ptr *QDomCharacterData) ReplaceData(offset uint, count uint, arg string) {
	if ptr.Pointer() != nil {
		...
		C.QDomCharacterData_ReplaceData(ptr.Pointer(), C.ulong(uint32(offset)), C.ulong(uint32(count)), C.struct_QtXml_PackedString{argC, C.longlong(len(arg))})
	}
}
...
func (ptr *QDomCharacterData) SetData(v string) {
	if ptr.Pointer() != nil {
		...
		C.QDomCharacterData_SetData(ptr.Pointer(), C.struct_QtXml_PackedString{vC, C.longlong(len(v))})
	}
}
...
func (ptr *QDomDocument) CreateAttribute(name string) *QDomAttr {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomAttrFromPointer(C.QDomDocument_CreateAttribute(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*QDomAttr).DestroyQDomAttr)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) CreateAttributeNS(nsURI string, qName string) *QDomAttr {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomAttrFromPointer(C.QDomDocument_CreateAttributeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}))
		runtime.SetFinalizer(tmpValue, (*QDomAttr).DestroyQDomAttr)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) CreateCDATASection(value string) *QDomCDATASection {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomCDATASectionFromPointer(C.QDomDocument_CreateCDATASection(ptr.Pointer(), C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}))
		runtime.SetFinalizer(tmpValue, (*QDomCDATASection).DestroyQDomCDATASection)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) CreateComment(value string) *QDomComment {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomCommentFromPointer(C.QDomDocument_CreateComment(ptr.Pointer(), C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}))
		runtime.SetFinalizer(tmpValue, (*QDomComment).DestroyQDomComment)
		return tmpValue
	}
	return nil
...
func NewQDomDocument2(name string) *QDomDocument {
	...
	var tmpValue = NewQDomDocumentFromPointer(C.QDomDocument_NewQDomDocument2(C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
	runtime.SetFinalizer(tmpValue, (*QDomDocument).DestroyQDomDocument)
	return tmpValue
}
...
func (ptr *QDomDocument) CreateElement(tagName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomDocument_CreateElement(ptr.Pointer(), C.struct_QtXml_PackedString{tagNameC, C.longlong(len(tagName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) CreateElementNS(nsURI string, qName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomDocument_CreateElementNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) ElementById(elementId string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomDocument_ElementById(ptr.Pointer(), C.struct_QtXml_PackedString{elementIdC, C.longlong(len(elementId))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomDocument) CreateEntityReference(name string) *QDomEntityReference {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomEntityReferenceFromPointer(C.QDomDocument_CreateEntityReference(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
...
func (ptr *QDomDocument) ElementsByTagNameNS(nsURI string, localName string) *QDomNodeList {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeListFromPointer(C.QDomDocument_ElementsByTagNameNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
...
func (ptr *QDomDocument) CreateProcessingInstruction(target string, data string) *QDomProcessingInstruction {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomProcessingInstructionFromPointer(C.QDomDocument_CreateProcessingInstruction(ptr.Pointer(), C.struct_QtXml_PackedString{targetC, C.longlong(len(target))}, C.struct_QtXml_PackedString{dataC, C.longlong(len(data))}))
...
func (ptr *QDomDocument) CreateTextNode(value string) *QDomText {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomTextFromPointer(C.QDomDocument_CreateTextNode(ptr.Pointer(), C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}))
...
func (ptr *QDomDocument) SetContent7(dev core.QIODevice_ITF, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent7(ptr.Pointer(), core.PointerFromQIODevice(dev), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent3(dev core.QIODevice_ITF, namespaceProcessing bool, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent3(ptr.Pointer(), core.PointerFromQIODevice(dev), C.char(int8(qt.GoBoolToInt(namespaceProcessing))), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent8(source QXmlInputSource_ITF, reader QXmlReader_ITF, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent8(ptr.Pointer(), PointerFromQXmlInputSource(source), PointerFromQXmlReader(reader), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent4(source QXmlInputSource_ITF, namespaceProcessing bool, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent4(ptr.Pointer(), PointerFromQXmlInputSource(source), C.char(int8(qt.GoBoolToInt(namespaceProcessing))), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent5(buffer core.QByteArray_ITF, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent5(ptr.Pointer(), core.PointerFromQByteArray(buffer), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent(data core.QByteArray_ITF, namespaceProcessing bool, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent(ptr.Pointer(), core.PointerFromQByteArray(data), C.char(int8(qt.GoBoolToInt(namespaceProcessing))), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent6(text string, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent6(ptr.Pointer(), C.struct_QtXml_PackedString{textC, C.longlong(len(text))}, C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) SetContent2(text string, namespaceProcessing bool, errorMsg string, errorLine int, errorColumn int) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomDocument_SetContent2(ptr.Pointer(), C.struct_QtXml_PackedString{textC, C.longlong(len(text))}, C.char(int8(qt.GoBoolToInt(namespaceProcessing))), C.struct_QtXml_PackedString{errorMsgC, C.longlong(len(errorMsg))}, C.int(int32(errorLine)), C.int(int32(errorColumn))) != 0
	}
	return false
}
...
func (ptr *QDomDocument) ToByteArray(indent int) *core.QByteArray {
	if ptr.Pointer() != nil {
		var tmpValue = core.NewQByteArrayFromPointer(C.QDomDocument_ToByteArray(ptr.Pointer(), C.int(int32(indent))))
...
func (ptr *QDomDocument) ElementsByTagName(tagname string) *QDomNodeList {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeListFromPointer(C.QDomDocument_ElementsByTagName(ptr.Pointer(), C.struct_QtXml_PackedString{tagnameC, C.longlong(len(tagname))}))
		runtime.SetFinalizer(tmpValue, (*QDomNodeList).DestroyQDomNodeList)
		return tmpValue
	}
	return nil
...
func (ptr *QDomElement) AttributeNode(name string) *QDomAttr {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomAttrFromPointer(C.QDomElement_AttributeNode(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*QDomAttr).DestroyQDomAttr)
		return tmpValue
	}
	return nil
...
func (ptr *QDomElement) AttributeNodeNS(nsURI string, localName string) *QDomAttr {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomAttrFromPointer(C.QDomElement_AttributeNodeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
		runtime.SetFinalizer(tmpValue, (*QDomAttr).DestroyQDomAttr)
		return tmpValue
	}
	return nil
...
func (ptr *QDomElement) RemoveAttribute(name string) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_RemoveAttribute(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))})
	}
}
...
func (ptr *QDomElement) RemoveAttributeNS(nsURI string, localName string) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_RemoveAttributeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))})
	}
}
...
func (ptr *QDomElement) SetAttribute(name string, value string) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))})
	}
}
...
func (ptr *QDomElement) SetAttribute7(name string, value float64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute7(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.double(value))
	}
}
...
func (ptr *QDomElement) SetAttribute6(name string, value float32) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute6(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.float(value))
	}
}
...
func (ptr *QDomElement) SetAttribute4(name string, value int) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute4(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.int(int32(value)))
	}
}
...
func (ptr *QDomElement) SetAttribute2(name string, value int64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute2(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.longlong(value))
	}
}
...
func (ptr *QDomElement) SetAttribute3(name string, value uint64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute3(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.ulonglong(value))
	}
}
...
func (ptr *QDomElement) SetAttribute5(name string, value uint) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttribute5(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.uint(uint32(value)))
	}
}
...
func (ptr *QDomElement) SetAttributeNS(nsURI string, qName string, value string) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))})
	}
}
...
func (ptr *QDomElement) SetAttributeNS6(nsURI string, qName string, value float64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS6(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.double(value))
	}
}
...
func (ptr *QDomElement) SetAttributeNS2(nsURI string, qName string, value int) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS2(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.int(int32(value)))
	}
}
...
func (ptr *QDomElement) SetAttributeNS4(nsURI string, qName string, value int64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS4(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.longlong(value))
	}
}
...
func (ptr *QDomElement) SetAttributeNS5(nsURI string, qName string, value uint64) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS5(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.ulonglong(value))
	}
}
...
func (ptr *QDomElement) SetAttributeNS3(nsURI string, qName string, value uint) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetAttributeNS3(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.uint(uint32(value)))
	}
}
...
func (ptr *QDomElement) SetTagName(name string) {
	if ptr.Pointer() != nil {
		...
		C.QDomElement_SetTagName(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))})
	}
}
...
func (ptr *QDomElement) ElementsByTagName(tagname string) *QDomNodeList {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeListFromPointer(C.QDomElement_ElementsByTagName(ptr.Pointer(), C.struct_QtXml_PackedString{tagnameC, C.longlong(len(tagname))}))
		runtime.SetFinalizer(tmpValue, (*QDomNodeList).DestroyQDomNodeList)
		return tmpValue
	}
	return nil
...
func (ptr *QDomElement) ElementsByTagNameNS(nsURI string, localName string) *QDomNodeList {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeListFromPointer(C.QDomElement_ElementsByTagNameNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
		runtime.SetFinalizer(tmpValue, (*QDomNodeList).DestroyQDomNodeList)
		return tmpValue
	}
	return nil
...
func (ptr *QDomElement) Attribute(name string, defValue string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QDomElement_Attribute(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{defValueC, C.longlong(len(defValue))}))
	}
	return ""
}
...
func (ptr *QDomElement) AttributeNS(nsURI string, localName string, defValue string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QDomElement_AttributeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{defValueC, C.longlong(len(defValue))}))
	}
	return ""
}
...
func (ptr *QDomElement) HasAttribute(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomElement_HasAttribute(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QDomElement) HasAttributeNS(nsURI string, localName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomElement_HasAttributeNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}) != 0
	}
	return false
}
...
func (ptr *QDomImplementation) CreateDocument(nsURI string, qName string, doctype QDomDocumentType_ITF) *QDomDocument {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomDocumentFromPointer(C.QDomImplementation_CreateDocument(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, PointerFromQDomDocumentType(doctype)))
		runtime.SetFinalizer(tmpValue, (*QDomDocument).DestroyQDomDocument)
		return tmpValue
	}
	return nil
...
func (ptr *QDomImplementation) CreateDocumentType(qName string, publicId string, systemId string) *QDomDocumentType {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomDocumentTypeFromPointer(C.QDomImplementation_CreateDocumentType(ptr.Pointer(), C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}))
		runtime.SetFinalizer(tmpValue, (*QDomDocumentType).DestroyQDomDocumentType)
		return tmpValue
	}
	return nil
...
func (ptr *QDomImplementation) HasFeature(feature string, version string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomImplementation_HasFeature(ptr.Pointer(), C.struct_QtXml_PackedString{featureC, C.longlong(len(feature))}, C.struct_QtXml_PackedString{versionC, C.longlong(len(version))}) != 0
	}
	return false
}
...
func (ptr *QDomNamedNodeMap) RemoveNamedItem(name string) *QDomNode {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeFromPointer(C.QDomNamedNodeMap_RemoveNamedItem(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*QDomNode).DestroyQDomNode)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNamedNodeMap) RemoveNamedItemNS(nsURI string, localName string) *QDomNode {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeFromPointer(C.QDomNamedNodeMap_RemoveNamedItemNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
		runtime.SetFinalizer(tmpValue, (*QDomNode).DestroyQDomNode)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNamedNodeMap) NamedItem(name string) *QDomNode {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeFromPointer(C.QDomNamedNodeMap_NamedItem(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*QDomNode).DestroyQDomNode)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNamedNodeMap) NamedItemNS(nsURI string, localName string) *QDomNode {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeFromPointer(C.QDomNamedNodeMap_NamedItemNS(ptr.Pointer(), C.struct_QtXml_PackedString{nsURIC, C.longlong(len(nsURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
		runtime.SetFinalizer(tmpValue, (*QDomNode).DestroyQDomNode)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNamedNodeMap) Contains(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomNamedNodeMap_Contains(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QDomNode) SetNodeValue(v string) {
	if ptr.Pointer() != nil {
		...
		C.QDomNode_SetNodeValue(ptr.Pointer(), C.struct_QtXml_PackedString{vC, C.longlong(len(v))})
	}
}
...
func (ptr *QDomNode) SetPrefix(pre string) {
	if ptr.Pointer() != nil {
		...
		C.QDomNode_SetPrefix(ptr.Pointer(), C.struct_QtXml_PackedString{preC, C.longlong(len(pre))})
	}
}
...
func (ptr *QDomNode) FirstChildElement(tagName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomNode_FirstChildElement(ptr.Pointer(), C.struct_QtXml_PackedString{tagNameC, C.longlong(len(tagName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNode) LastChildElement(tagName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomNode_LastChildElement(ptr.Pointer(), C.struct_QtXml_PackedString{tagNameC, C.longlong(len(tagName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNode) NextSiblingElement(tagName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomNode_NextSiblingElement(ptr.Pointer(), C.struct_QtXml_PackedString{tagNameC, C.longlong(len(tagName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNode) PreviousSiblingElement(tagName string) *QDomElement {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomElementFromPointer(C.QDomNode_PreviousSiblingElement(ptr.Pointer(), C.struct_QtXml_PackedString{tagNameC, C.longlong(len(tagName))}))
		runtime.SetFinalizer(tmpValue, (*QDomElement).DestroyQDomElement)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNode) NamedItem(name string) *QDomNode {
	if ptr.Pointer() != nil {
		...
		var tmpValue = NewQDomNodeFromPointer(C.QDomNode_NamedItem(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*QDomNode).DestroyQDomNode)
		return tmpValue
	}
	return nil
...
func (ptr *QDomNode) IsSupported(feature string, version string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QDomNode_IsSupported(ptr.Pointer(), C.struct_QtXml_PackedString{featureC, C.longlong(len(feature))}, C.struct_QtXml_PackedString{versionC, C.longlong(len(version))}) != 0
	}
	return false
}
...
func (ptr *QDomProcessingInstruction) SetData(d string) {
	if ptr.Pointer() != nil {
		...
		C.QDomProcessingInstruction_SetData(ptr.Pointer(), C.struct_QtXml_PackedString{dC, C.longlong(len(d))})
	}
}
...
func callbackQXmlAttributes_DestroyQXmlAttributes(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlAttributes"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlAttributes) ConnectDestroyQXmlAttributes(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlAttributes"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlAttributes", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlAttributes", f)
		}
	}
}
...
func (ptr *QXmlAttributes) DisconnectDestroyQXmlAttributes() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlAttributes")
	}
}
...
func (ptr *QXmlAttributes) Append(qName string, uri string, localPart string, value string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlAttributes_Append(ptr.Pointer(), C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}, C.struct_QtXml_PackedString{localPartC, C.longlong(len(localPart))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))})
	}
}
...
func (ptr *QXmlAttributes) Type2(qName string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlAttributes_Type2(ptr.Pointer(), C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}))
	}
	return ""
}
...
func (ptr *QXmlAttributes) Type3(uri string, localName string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlAttributes_Type3(ptr.Pointer(), C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
	}
	return ""
}
...
func (ptr *QXmlAttributes) Value2(qName string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlAttributes_Value2(ptr.Pointer(), C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}))
	}
	return ""
}
...
func (ptr *QXmlAttributes) Value4(uri string, localName string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlAttributes_Value4(ptr.Pointer(), C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}))
	}
	return ""
}
...
func (ptr *QXmlAttributes) Index(qName string) int {
	if ptr.Pointer() != nil {
		...
		return int(int32(C.QXmlAttributes_Index(ptr.Pointer(), C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))})))
	}
	return 0
}
...
func (ptr *QXmlAttributes) Index3(uri string, localPart string) int {
	if ptr.Pointer() != nil {
		...
		return int(int32(C.QXmlAttributes_Index3(ptr.Pointer(), C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}, C.struct_QtXml_PackedString{localPartC, C.longlong(len(localPart))})))
	}
	return 0
}
...
func (ptr *QXmlContentHandler) ConnectCharacters(f func(ch string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "characters"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "characters", func(ch string) bool {
...
func (ptr *QXmlContentHandler) Characters(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_Characters(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlContentHandler) ConnectEndDocument(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endDocument"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endDocument", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
...
func (ptr *QXmlContentHandler) ConnectEndElement(f func(namespaceURI string, localName string, qName string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endElement"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endElement", func(namespaceURI string, localName string, qName string) bool {
...
func (ptr *QXmlContentHandler) EndElement(namespaceURI string, localName string, qName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_EndElement(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}) != 0
	}
	return false
}
...
func callbackQXmlContentHandler_EndPrefixMapping(ptr unsafe.Pointer, prefix C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "endPrefixMapping"); signal != nil {
...
func (ptr *QXmlContentHandler) ConnectEndPrefixMapping(f func(prefix string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endPrefixMapping"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endPrefixMapping", func(prefix string) bool {
				signal.(func(string) bool)(prefix)
				return f(prefix)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endPrefixMapping", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectEndPrefixMapping() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "endPrefixMapping")
	}
}
...
func (ptr *QXmlContentHandler) EndPrefixMapping(prefix string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_EndPrefixMapping(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}) != 0
	}
	return false
}
...
func callbackQXmlContentHandler_IgnorableWhitespace(ptr unsafe.Pointer, ch C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "ignorableWhitespace"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string) bool)(cGoUnpackString(ch)))))
	}
...
func (ptr *QXmlContentHandler) ConnectIgnorableWhitespace(f func(ch string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "ignorableWhitespace"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "ignorableWhitespace", func(ch string) bool {
				signal.(func(string) bool)(ch)
				return f(ch)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "ignorableWhitespace", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectIgnorableWhitespace() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "ignorableWhitespace")
	}
}
...
func (ptr *QXmlContentHandler) IgnorableWhitespace(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_IgnorableWhitespace(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlContentHandler) ConnectProcessingInstruction(f func(target string, data string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "processingInstruction"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "processingInstruction", func(target string, data string) bool {
...
func (ptr *QXmlContentHandler) ProcessingInstruction(target string, data string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_ProcessingInstruction(ptr.Pointer(), C.struct_QtXml_PackedString{targetC, C.longlong(len(target))}, C.struct_QtXml_PackedString{dataC, C.longlong(len(data))}) != 0
	}
	return false
}
...
func callbackQXmlContentHandler_SkippedEntity(ptr unsafe.Pointer, name C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "skippedEntity"); signal != nil {
...
func (ptr *QXmlContentHandler) ConnectSkippedEntity(f func(name string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "skippedEntity"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "skippedEntity", func(name string) bool {
				signal.(func(string) bool)(name)
				return f(name)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "skippedEntity", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectSkippedEntity() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "skippedEntity")
	}
}
...
func (ptr *QXmlContentHandler) SkippedEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_SkippedEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlContentHandler) ConnectStartDocument(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startDocument"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startDocument", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
...
func (ptr *QXmlContentHandler) ConnectStartElement(f func(namespaceURI string, localName string, qName string, atts *QXmlAttributes) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startElement"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startElement", func(namespaceURI string, localName string, qName string, atts *QXmlAttributes) bool {
...
func (ptr *QXmlContentHandler) StartElement(namespaceURI string, localName string, qName string, atts QXmlAttributes_ITF) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_StartElement(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, PointerFromQXmlAttributes(atts)) != 0
	}
	return false
}
...
func callbackQXmlContentHandler_StartPrefixMapping(ptr unsafe.Pointer, prefix C.struct_QtXml_PackedString, uri C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "startPrefixMapping"); signal != nil {
...
func (ptr *QXmlContentHandler) ConnectStartPrefixMapping(f func(prefix string, uri string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startPrefixMapping"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startPrefixMapping", func(prefix string, uri string) bool {
				signal.(func(string, string) bool)(prefix, uri)
				return f(prefix, uri)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startPrefixMapping", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectStartPrefixMapping() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "startPrefixMapping")
	}
}
...
func (ptr *QXmlContentHandler) StartPrefixMapping(prefix string, uri string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlContentHandler_StartPrefixMapping(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}, C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}) != 0
	}
	return false
}
...
func callbackQXmlContentHandler_SetDocumentLocator(ptr unsafe.Pointer, locator unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setDocumentLocator"); signal != nil {
...
func (ptr *QXmlContentHandler) ConnectSetDocumentLocator(f func(locator *QXmlLocator)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setDocumentLocator"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDocumentLocator", func(locator *QXmlLocator) {
				signal.(func(*QXmlLocator))(locator)
				f(locator)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDocumentLocator", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectSetDocumentLocator() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setDocumentLocator")
	}
}
...
func callbackQXmlContentHandler_DestroyQXmlContentHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlContentHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlContentHandler) ConnectDestroyQXmlContentHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlContentHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlContentHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlContentHandler", f)
		}
	}
}
...
func (ptr *QXmlContentHandler) DisconnectDestroyQXmlContentHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlContentHandler")
	}
}
...
func callbackQXmlContentHandler_ErrorString(ptr unsafe.Pointer) C.struct_QtXml_PackedString {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "errorString"); signal != nil {
		...
		return C.struct_QtXml_PackedString{C.CString(tempVal), C.longlong(len(tempVal))}
	}
	tempVal := ""
	return C.struct_QtXml_PackedString{C.CString(tempVal), C.longlong(len(tempVal))}
}
...
func callbackQXmlDTDHandler_NotationDecl(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, publicId C.struct_QtXml_PackedString, systemId C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "notationDecl"); signal != nil {
...
func (ptr *QXmlDTDHandler) ConnectNotationDecl(f func(name string, publicId string, systemId string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "notationDecl"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "notationDecl", func(name string, publicId string, systemId string) bool {
				signal.(func(string, string, string) bool)(name, publicId, systemId)
				return f(name, publicId, systemId)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "notationDecl", f)
		}
	}
}
...
func (ptr *QXmlDTDHandler) DisconnectNotationDecl() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "notationDecl")
	}
}
...
func (ptr *QXmlDTDHandler) NotationDecl(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDTDHandler_NotationDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func callbackQXmlDTDHandler_UnparsedEntityDecl(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, publicId C.struct_QtXml_PackedString, systemId C.struct_QtXml_PackedString, notationName C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "unparsedEntityDecl"); signal != nil {
...
func (ptr *QXmlDTDHandler) ConnectUnparsedEntityDecl(f func(name string, publicId string, systemId string, notationName string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "unparsedEntityDecl"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "unparsedEntityDecl", func(name string, publicId string, systemId string, notationName string) bool {
			...
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "unparsedEntityDecl", f)
		}
	}
}
...
func (ptr *QXmlDTDHandler) DisconnectUnparsedEntityDecl() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "unparsedEntityDecl")
	}
}
...
func (ptr *QXmlDTDHandler) UnparsedEntityDecl(name string, publicId string, systemId string, notationName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDTDHandler_UnparsedEntityDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}, C.struct_QtXml_PackedString{notationNameC, C.longlong(len(notationName))}) != 0
	}
	return false
}
...
func callbackQXmlDTDHandler_DestroyQXmlDTDHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlDTDHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlDTDHandler) ConnectDestroyQXmlDTDHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDTDHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDTDHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDTDHandler", f)
		}
	}
}
...
func (ptr *QXmlDTDHandler) DisconnectDestroyQXmlDTDHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDTDHandler")
	}
}
...
func callbackQXmlDeclHandler_AttributeDecl(ptr unsafe.Pointer, eName C.struct_QtXml_PackedString, aName C.struct_QtXml_PackedString, ty C.struct_QtXml_PackedString, valueDefault C.struct_QtXml_PackedString, value C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "attributeDecl"); signal != nil {
...
func (ptr *QXmlDeclHandler) ConnectAttributeDecl(f func(eName string, aName string, ty string, valueDefault string, value string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "attributeDecl"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "attributeDecl", func(eName string, aName string, ty string, valueDefault string, value string) bool {
			...
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "attributeDecl", f)
		}
	}
}
...
func (ptr *QXmlDeclHandler) DisconnectAttributeDecl() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "attributeDecl")
	}
}
...
func (ptr *QXmlDeclHandler) AttributeDecl(eName string, aName string, ty string, valueDefault string, value string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDeclHandler_AttributeDecl(ptr.Pointer(), C.struct_QtXml_PackedString{eNameC, C.longlong(len(eName))}, C.struct_QtXml_PackedString{aNameC, C.longlong(len(aName))}, C.struct_QtXml_PackedString{tyC, C.longlong(len(ty))}, C.struct_QtXml_PackedString{valueDefaultC, C.longlong(len(valueDefault))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}) != 0
	}
	return false
}
...
func callbackQXmlDeclHandler_ExternalEntityDecl(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, publicId C.struct_QtXml_PackedString, systemId C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "externalEntityDecl"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string, string, string) bool)(cGoUnpackString(name), cGoUnpackString(publicId), cGoUnpackString(systemId)))))
	}
...
func (ptr *QXmlDeclHandler) ConnectExternalEntityDecl(f func(name string, publicId string, systemId string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "externalEntityDecl"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "externalEntityDecl", func(name string, publicId string, systemId string) bool {
				signal.(func(string, string, string) bool)(name, publicId, systemId)
				return f(name, publicId, systemId)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "externalEntityDecl", f)
		}
	}
}
...
func (ptr *QXmlDeclHandler) DisconnectExternalEntityDecl() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "externalEntityDecl")
	}
}
...
func (ptr *QXmlDeclHandler) ExternalEntityDecl(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDeclHandler_ExternalEntityDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func callbackQXmlDeclHandler_InternalEntityDecl(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, value C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "internalEntityDecl"); signal != nil {
...
func (ptr *QXmlDeclHandler) ConnectInternalEntityDecl(f func(name string, value string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "internalEntityDecl"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "internalEntityDecl", func(name string, value string) bool {
				signal.(func(string, string) bool)(name, value)
				return f(name, value)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "internalEntityDecl", f)
		}
	}
}
...
func (ptr *QXmlDeclHandler) DisconnectInternalEntityDecl() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "internalEntityDecl")
	}
}
...
func (ptr *QXmlDeclHandler) InternalEntityDecl(name string, value string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDeclHandler_InternalEntityDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}) != 0
	}
	return false
}
...
func callbackQXmlDeclHandler_DestroyQXmlDeclHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlDeclHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlDeclHandler) ConnectDestroyQXmlDeclHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDeclHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDeclHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDeclHandler", f)
		}
	}
}
...
func (ptr *QXmlDeclHandler) DisconnectDestroyQXmlDeclHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDeclHandler")
	}
}
...
func (ptr *QXmlDefaultHandler) Characters(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_Characters(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) CharactersDefault(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_CharactersDefault(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) ConnectComment(f func(ch string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "comment"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "comment", func(ch string) bool {
				signal.(func(string) bool)(ch)
				return f(ch)
			})
		} else {
...
func (ptr *QXmlDefaultHandler) Comment(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_Comment(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) CommentDefault(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_CommentDefault(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_EndCDATA(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "endCDATA"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func() bool)())))
	}
...
func (ptr *QXmlDefaultHandler) ConnectEndCDATA(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endCDATA"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endCDATA", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endCDATA", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectEndCDATA() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "endCDATA")
	}
}
...
func callbackQXmlDefaultHandler_EndDTD(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "endDTD"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func() bool)())))
	}
...
func (ptr *QXmlDefaultHandler) ConnectEndDTD(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endDTD"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endDTD", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endDTD", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectEndDTD() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "endDTD")
	}
}
...
func (ptr *QXmlDefaultHandler) EndElement(namespaceURI string, localName string, qName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndElement(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) EndElementDefault(namespaceURI string, localName string, qName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndElementDefault(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_EndEntity(ptr unsafe.Pointer, name C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "endEntity"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string) bool)(cGoUnpackString(name)))))
	}
...
func (ptr *QXmlDefaultHandler) ConnectEndEntity(f func(name string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "endEntity"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endEntity", func(name string) bool {
				signal.(func(string) bool)(name)
				return f(name)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "endEntity", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectEndEntity() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "endEntity")
	}
}
...
func (ptr *QXmlDefaultHandler) EndEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) EndEntityDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndEntityDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) EndPrefixMapping(prefix string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndPrefixMapping(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) EndPrefixMappingDefault(prefix string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_EndPrefixMappingDefault(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) ConnectError(f func(exception *QXmlParseException) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "error"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "error", func(exception *QXmlParseException) bool {
...
func (ptr *QXmlDefaultHandler) ExternalEntityDecl(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_ExternalEntityDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) ExternalEntityDeclDefault(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_ExternalEntityDeclDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_FatalError(ptr unsafe.Pointer, exception unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "fatalError"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(*QXmlParseException) bool)(NewQXmlParseExceptionFromPointer(exception)))))
	}
...
func (ptr *QXmlDefaultHandler) ConnectFatalError(f func(exception *QXmlParseException) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "fatalError"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fatalError", func(exception *QXmlParseException) bool {
				signal.(func(*QXmlParseException) bool)(exception)
				return f(exception)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fatalError", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectFatalError() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "fatalError")
	}
}
...
func (ptr *QXmlDefaultHandler) IgnorableWhitespace(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_IgnorableWhitespace(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) IgnorableWhitespaceDefault(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_IgnorableWhitespaceDefault(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) InternalEntityDecl(name string, value string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_InternalEntityDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) InternalEntityDeclDefault(name string, value string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_InternalEntityDeclDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{valueC, C.longlong(len(value))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) NotationDecl(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_NotationDecl(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) NotationDeclDefault(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_NotationDeclDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) ProcessingInstruction(target string, data string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_ProcessingInstruction(ptr.Pointer(), C.struct_QtXml_PackedString{targetC, C.longlong(len(target))}, C.struct_QtXml_PackedString{dataC, C.longlong(len(data))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) ProcessingInstructionDefault(target string, data string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_ProcessingInstructionDefault(ptr.Pointer(), C.struct_QtXml_PackedString{targetC, C.longlong(len(target))}, C.struct_QtXml_PackedString{dataC, C.longlong(len(data))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) SkippedEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_SkippedEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) SkippedEntityDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_SkippedEntityDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_StartCDATA(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "startCDATA"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func() bool)())))
	}
...
func (ptr *QXmlDefaultHandler) ConnectStartCDATA(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startCDATA"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startCDATA", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startCDATA", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectStartCDATA() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "startCDATA")
	}
}
...
func callbackQXmlDefaultHandler_StartDTD(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, publicId C.struct_QtXml_PackedString, systemId C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "startDTD"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string, string, string) bool)(cGoUnpackString(name), cGoUnpackString(publicId), cGoUnpackString(systemId)))))
	}
...
func (ptr *QXmlDefaultHandler) ConnectStartDTD(f func(name string, publicId string, systemId string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startDTD"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startDTD", func(name string, publicId string, systemId string) bool {
				signal.(func(string, string, string) bool)(name, publicId, systemId)
				return f(name, publicId, systemId)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startDTD", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectStartDTD() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "startDTD")
	}
}
...
func (ptr *QXmlDefaultHandler) StartDTD(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartDTD(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartDTDDefault(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartDTDDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartElement(namespaceURI string, localName string, qName string, atts QXmlAttributes_ITF) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartElement(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, PointerFromQXmlAttributes(atts)) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartElementDefault(namespaceURI string, localName string, qName string, atts QXmlAttributes_ITF) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartElementDefault(ptr.Pointer(), C.struct_QtXml_PackedString{namespaceURIC, C.longlong(len(namespaceURI))}, C.struct_QtXml_PackedString{localNameC, C.longlong(len(localName))}, C.struct_QtXml_PackedString{qNameC, C.longlong(len(qName))}, PointerFromQXmlAttributes(atts)) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_StartEntity(ptr unsafe.Pointer, name C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "startEntity"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string) bool)(cGoUnpackString(name)))))
	}
...
func (ptr *QXmlDefaultHandler) ConnectStartEntity(f func(name string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "startEntity"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startEntity", func(name string) bool {
				signal.(func(string) bool)(name)
				return f(name)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "startEntity", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectStartEntity() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "startEntity")
	}
}
...
func (ptr *QXmlDefaultHandler) StartEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartEntityDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartEntityDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartPrefixMapping(prefix string, uri string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartPrefixMapping(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}, C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}) != 0
	}
	return false
}
...
func (ptr *QXmlDefaultHandler) StartPrefixMappingDefault(prefix string, uri string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlDefaultHandler_StartPrefixMappingDefault(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}, C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}) != 0
	}
	return false
}
...
func callbackQXmlDefaultHandler_Warning(ptr unsafe.Pointer, exception unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "warning"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(*QXmlParseException) bool)(NewQXmlParseExceptionFromPointer(exception)))))
	}
...
func (ptr *QXmlDefaultHandler) ConnectWarning(f func(exception *QXmlParseException) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "warning"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "warning", func(exception *QXmlParseException) bool {
				signal.(func(*QXmlParseException) bool)(exception)
				return f(exception)
			})
		} else {
...
func (ptr *QXmlDefaultHandler) DisconnectWarning() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "warning")
	}
}
...
func callbackQXmlDefaultHandler_DestroyQXmlDefaultHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlDefaultHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlDefaultHandler) ConnectDestroyQXmlDefaultHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDefaultHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDefaultHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDefaultHandler", f)
		}
	}
}
...
func (ptr *QXmlDefaultHandler) DisconnectDestroyQXmlDefaultHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlDefaultHandler")
	}
}
...
func callbackQXmlEntityResolver_DestroyQXmlEntityResolver(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlEntityResolver"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlEntityResolver) ConnectDestroyQXmlEntityResolver(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlEntityResolver"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlEntityResolver", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlEntityResolver", f)
		}
	}
}
...
func (ptr *QXmlEntityResolver) DisconnectDestroyQXmlEntityResolver() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlEntityResolver")
	}
}
...
func callbackQXmlErrorHandler_DestroyQXmlErrorHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlErrorHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlErrorHandler) ConnectDestroyQXmlErrorHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlErrorHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlErrorHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlErrorHandler", f)
		}
	}
}
...
func (ptr *QXmlErrorHandler) DisconnectDestroyQXmlErrorHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlErrorHandler")
	}
}
...
func (ptr *QXmlInputSource) ConnectNext(f func() *core.QChar) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "next"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "next", func() *core.QChar {
...
func callbackQXmlInputSource_FromRawData(ptr unsafe.Pointer, data unsafe.Pointer, beginning C.char) C.struct_QtXml_PackedString {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "fromRawData"); signal != nil {
...
func (ptr *QXmlInputSource) ConnectFromRawData(f func(data *core.QByteArray, beginning bool) string) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "fromRawData"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fromRawData", func(data *core.QByteArray, beginning bool) string {
				signal.(func(*core.QByteArray, bool) string)(data, beginning)
				return f(data, beginning)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fromRawData", f)
		}
	}
}
...
func (ptr *QXmlInputSource) DisconnectFromRawData() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "fromRawData")
	}
}
...
func callbackQXmlInputSource_FetchData(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "fetchData"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlInputSource) ConnectFetchData(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "fetchData"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fetchData", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "fetchData", f)
		}
	}
}
...
func (ptr *QXmlInputSource) DisconnectFetchData() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "fetchData")
	}
}
...
func callbackQXmlInputSource_SetData2(ptr unsafe.Pointer, dat unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setData2"); signal != nil {
...
func (ptr *QXmlInputSource) ConnectSetData2(f func(dat *core.QByteArray)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setData2"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setData2", func(dat *core.QByteArray) {
				signal.(func(*core.QByteArray))(dat)
				f(dat)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setData2", f)
		}
	}
}
...
func (ptr *QXmlInputSource) DisconnectSetData2() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setData2")
	}
}
...
func (ptr *QXmlInputSource) ConnectSetData(f func(dat string)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setData"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setData", func(dat string) {
...
func (ptr *QXmlInputSource) SetData(dat string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlInputSource_SetData(ptr.Pointer(), C.struct_QtXml_PackedString{datC, C.longlong(len(dat))})
	}
}
...
func (ptr *QXmlInputSource) SetDataDefault(dat string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlInputSource_SetDataDefault(ptr.Pointer(), C.struct_QtXml_PackedString{datC, C.longlong(len(dat))})
	}
}
...
func callbackQXmlInputSource_DestroyQXmlInputSource(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlInputSource"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlInputSource) ConnectDestroyQXmlInputSource(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlInputSource"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlInputSource", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlInputSource", f)
		}
	}
}
...
func (ptr *QXmlInputSource) DisconnectDestroyQXmlInputSource() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlInputSource")
	}
}
...
func (ptr *QXmlInputSource) ConnectData(f func() string) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "data"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "data", func() string {
				signal.(func() string)()
				return f()
			})
		} else {
...
func (ptr *QXmlLexicalHandler) Comment(ch string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlLexicalHandler_Comment(ptr.Pointer(), C.struct_QtXml_PackedString{chC, C.longlong(len(ch))}) != 0
	}
	return false
}
...
func (ptr *QXmlLexicalHandler) EndEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlLexicalHandler_EndEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlLexicalHandler) StartDTD(name string, publicId string, systemId string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlLexicalHandler_StartDTD(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.struct_QtXml_PackedString{publicIdC, C.longlong(len(publicId))}, C.struct_QtXml_PackedString{systemIdC, C.longlong(len(systemId))}) != 0
	}
	return false
}
...
func (ptr *QXmlLexicalHandler) StartEntity(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlLexicalHandler_StartEntity(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func callbackQXmlLexicalHandler_DestroyQXmlLexicalHandler(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlLexicalHandler"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlLexicalHandler) ConnectDestroyQXmlLexicalHandler(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLexicalHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLexicalHandler", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLexicalHandler", f)
		}
	}
}
...
func (ptr *QXmlLexicalHandler) DisconnectDestroyQXmlLexicalHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLexicalHandler")
	}
}
...
func callbackQXmlLocator_DestroyQXmlLocator(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlLocator"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlLocator) ConnectDestroyQXmlLocator(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLocator"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLocator", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLocator", f)
		}
	}
}
...
func (ptr *QXmlLocator) DisconnectDestroyQXmlLocator() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlLocator")
	}
}
...
func callbackQXmlLocator_ColumnNumber(ptr unsafe.Pointer) C.int {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "columnNumber"); signal != nil {
...
func (ptr *QXmlLocator) ConnectColumnNumber(f func() int) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "columnNumber"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "columnNumber", func() int {
				signal.(func() int)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "columnNumber", f)
		}
	}
}
...
func (ptr *QXmlLocator) DisconnectColumnNumber() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "columnNumber")
	}
}
...
func callbackQXmlLocator_LineNumber(ptr unsafe.Pointer) C.int {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "lineNumber"); signal != nil {
		return C.int(int32(signal.(func() int)()))
	}
...
func (ptr *QXmlLocator) ConnectLineNumber(f func() int) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "lineNumber"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "lineNumber", func() int {
				signal.(func() int)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "lineNumber", f)
		}
	}
}
...
func (ptr *QXmlLocator) DisconnectLineNumber() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "lineNumber")
	}
}
...
func (ptr *QXmlNamespaceSupport) SetPrefix(pre string, uri string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlNamespaceSupport_SetPrefix(ptr.Pointer(), C.struct_QtXml_PackedString{preC, C.longlong(len(pre))}, C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))})
	}
}
...
func (ptr *QXmlNamespaceSupport) Prefix(uri string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlNamespaceSupport_Prefix(ptr.Pointer(), C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))}))
	}
	return ""
}
...
func (ptr *QXmlNamespaceSupport) Uri(prefix string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QXmlNamespaceSupport_Uri(ptr.Pointer(), C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}))
	}
	return ""
}
...
func (ptr *QXmlNamespaceSupport) Prefixes2(uri string) []string {
	if ptr.Pointer() != nil {
		...
		return strings.Split(cGoUnpackString(C.QXmlNamespaceSupport_Prefixes2(ptr.Pointer(), C.struct_QtXml_PackedString{uriC, C.longlong(len(uri))})), "|")
	}
	return make([]string, 0)
}
...
func (ptr *QXmlNamespaceSupport) ProcessName(qname string, isAttribute bool, nsuri string, localname string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlNamespaceSupport_ProcessName(ptr.Pointer(), C.struct_QtXml_PackedString{qnameC, C.longlong(len(qname))}, C.char(int8(qt.GoBoolToInt(isAttribute))), C.struct_QtXml_PackedString{nsuriC, C.longlong(len(nsuri))}, C.struct_QtXml_PackedString{localnameC, C.longlong(len(localname))})
	}
}
...
func (ptr *QXmlNamespaceSupport) SplitName(qname string, prefix string, localname string) {
	if ptr.Pointer() != nil {
		...
		C.QXmlNamespaceSupport_SplitName(ptr.Pointer(), C.struct_QtXml_PackedString{qnameC, C.longlong(len(qname))}, C.struct_QtXml_PackedString{prefixC, C.longlong(len(prefix))}, C.struct_QtXml_PackedString{localnameC, C.longlong(len(localname))})
	}
}
...
func NewQXmlParseException(name string, c int, l int, p string, s string) *QXmlParseException {
	...
	var tmpValue = NewQXmlParseExceptionFromPointer(C.QXmlParseException_NewQXmlParseException(C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.int(int32(c)), C.int(int32(l)), C.struct_QtXml_PackedString{pC, C.longlong(len(p))}, C.struct_QtXml_PackedString{sC, C.longlong(len(s))}))
...
func callbackQXmlReader_Parse(ptr unsafe.Pointer, input unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "parse"); signal != nil {
...
func (ptr *QXmlReader) ConnectParse(f func(input *QXmlInputSource) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "parse"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse", func(input *QXmlInputSource) bool {
				signal.(func(*QXmlInputSource) bool)(input)
				return f(input)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectParse() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "parse")
	}
}
...
func callbackQXmlReader_SetContentHandler(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setContentHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetContentHandler(f func(handler *QXmlContentHandler)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setContentHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setContentHandler", func(handler *QXmlContentHandler) {
				signal.(func(*QXmlContentHandler))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setContentHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetContentHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setContentHandler")
	}
}
...
func callbackQXmlReader_SetDTDHandler(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setDTDHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetDTDHandler(f func(handler *QXmlDTDHandler)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setDTDHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDTDHandler", func(handler *QXmlDTDHandler) {
				signal.(func(*QXmlDTDHandler))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDTDHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetDTDHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setDTDHandler")
	}
}
...
func callbackQXmlReader_SetDeclHandler(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setDeclHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetDeclHandler(f func(handler *QXmlDeclHandler)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setDeclHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDeclHandler", func(handler *QXmlDeclHandler) {
				signal.(func(*QXmlDeclHandler))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setDeclHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetDeclHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setDeclHandler")
	}
}
...
func callbackQXmlReader_SetEntityResolver(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setEntityResolver"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetEntityResolver(f func(handler *QXmlEntityResolver)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setEntityResolver"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setEntityResolver", func(handler *QXmlEntityResolver) {
				signal.(func(*QXmlEntityResolver))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setEntityResolver", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetEntityResolver() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setEntityResolver")
	}
}
...
func callbackQXmlReader_SetErrorHandler(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setErrorHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetErrorHandler(f func(handler *QXmlErrorHandler)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setErrorHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setErrorHandler", func(handler *QXmlErrorHandler) {
				signal.(func(*QXmlErrorHandler))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setErrorHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetErrorHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setErrorHandler")
	}
}
...
func callbackQXmlReader_SetFeature(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, value C.char) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setFeature"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetFeature(f func(name string, value bool)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setFeature"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setFeature", func(name string, value bool) {
				signal.(func(string, bool))(name, value)
				f(name, value)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setFeature", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetFeature() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setFeature")
	}
}
...
func (ptr *QXmlReader) SetFeature(name string, value bool) {
	if ptr.Pointer() != nil {
		...
		C.QXmlReader_SetFeature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(value))))
	}
}
...
func callbackQXmlReader_SetLexicalHandler(ptr unsafe.Pointer, handler unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setLexicalHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectSetLexicalHandler(f func(handler *QXmlLexicalHandler)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setLexicalHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setLexicalHandler", func(handler *QXmlLexicalHandler) {
				signal.(func(*QXmlLexicalHandler))(handler)
				f(handler)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setLexicalHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectSetLexicalHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setLexicalHandler")
	}
}
...
func (ptr *QXmlReader) ConnectSetProperty(f func(name string, value unsafe.Pointer)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setProperty"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setProperty", func(name string, value unsafe.Pointer) {
...
func (ptr *QXmlReader) SetProperty(name string, value unsafe.Pointer) {
	if ptr.Pointer() != nil {
		...
		C.QXmlReader_SetProperty(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, value)
	}
}

//export callbackQXmlReader_DestroyQXmlReader
func callbackQXmlReader_DestroyQXmlReader(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlReader"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlReader) ConnectDestroyQXmlReader(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlReader"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlReader", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlReader", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectDestroyQXmlReader() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlReader")
	}
}
...
func callbackQXmlReader_ContentHandler(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "contentHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectContentHandler(f func() *QXmlContentHandler) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "contentHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "contentHandler", func() *QXmlContentHandler {
				signal.(func() *QXmlContentHandler)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "contentHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectContentHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "contentHandler")
	}
}
...
func callbackQXmlReader_DTDHandler(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "DTDHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectDTDHandler(f func() *QXmlDTDHandler) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "DTDHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "DTDHandler", func() *QXmlDTDHandler {
				signal.(func() *QXmlDTDHandler)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "DTDHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectDTDHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "DTDHandler")
	}
}
...
func callbackQXmlReader_DeclHandler(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "declHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectDeclHandler(f func() *QXmlDeclHandler) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "declHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "declHandler", func() *QXmlDeclHandler {
				signal.(func() *QXmlDeclHandler)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "declHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectDeclHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "declHandler")
	}
}
...
func callbackQXmlReader_EntityResolver(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "entityResolver"); signal != nil {
...
func (ptr *QXmlReader) ConnectEntityResolver(f func() *QXmlEntityResolver) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "entityResolver"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "entityResolver", func() *QXmlEntityResolver {
				signal.(func() *QXmlEntityResolver)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "entityResolver", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectEntityResolver() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "entityResolver")
	}
}
...
func callbackQXmlReader_ErrorHandler(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "errorHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectErrorHandler(f func() *QXmlErrorHandler) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "errorHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "errorHandler", func() *QXmlErrorHandler {
				signal.(func() *QXmlErrorHandler)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "errorHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectErrorHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "errorHandler")
	}
}
...
func callbackQXmlReader_LexicalHandler(ptr unsafe.Pointer) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "lexicalHandler"); signal != nil {
...
func (ptr *QXmlReader) ConnectLexicalHandler(f func() *QXmlLexicalHandler) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "lexicalHandler"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "lexicalHandler", func() *QXmlLexicalHandler {
				signal.(func() *QXmlLexicalHandler)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "lexicalHandler", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectLexicalHandler() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "lexicalHandler")
	}
}
...
func callbackQXmlReader_Feature(ptr unsafe.Pointer, name C.struct_QtXml_PackedString, ok C.char) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "feature"); signal != nil {
...
func (ptr *QXmlReader) ConnectFeature(f func(name string, ok bool) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "feature"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "feature", func(name string, ok bool) bool {
				signal.(func(string, bool) bool)(name, ok)
				return f(name, ok)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "feature", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectFeature() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "feature")
	}
}
...
func (ptr *QXmlReader) Feature(name string, ok bool) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlReader_Feature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))) != 0
	}
	return false
}
...
func callbackQXmlReader_HasFeature(ptr unsafe.Pointer, name C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "hasFeature"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string) bool)(cGoUnpackString(name)))))
	}
...
func (ptr *QXmlReader) ConnectHasFeature(f func(name string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "hasFeature"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "hasFeature", func(name string) bool {
				signal.(func(string) bool)(name)
				return f(name)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "hasFeature", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectHasFeature() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "hasFeature")
	}
}
...
func (ptr *QXmlReader) HasFeature(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlReader_HasFeature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func callbackQXmlReader_HasProperty(ptr unsafe.Pointer, name C.struct_QtXml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "hasProperty"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(string) bool)(cGoUnpackString(name)))))
	}
...
func (ptr *QXmlReader) ConnectHasProperty(f func(name string) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "hasProperty"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "hasProperty", func(name string) bool {
				signal.(func(string) bool)(name)
				return f(name)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "hasProperty", f)
		}
	}
}
...
func (ptr *QXmlReader) DisconnectHasProperty() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "hasProperty")
	}
}
...
func (ptr *QXmlReader) HasProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlReader_HasProperty(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlReader) ConnectProperty(f func(name string, ok bool) unsafe.Pointer) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "property"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "property", func(name string, ok bool) unsafe.Pointer {
...
func (ptr *QXmlReader) Property(name string, ok bool) unsafe.Pointer {
	if ptr.Pointer() != nil {
		...
		return unsafe.Pointer(C.QXmlReader_Property(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))))
	}
	return nil
}
...
func callbackQXmlSimpleReader_Parse2(ptr unsafe.Pointer, input unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "parse2"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func(*QXmlInputSource) bool)(NewQXmlInputSourceFromPointer(input)))))
	}
...
func (ptr *QXmlSimpleReader) ConnectParse2(f func(input *QXmlInputSource) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "parse2"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse2", func(input *QXmlInputSource) bool {
				signal.(func(*QXmlInputSource) bool)(input)
				return f(input)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse2", f)
		}
	}
}
...
func (ptr *QXmlSimpleReader) DisconnectParse2() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "parse2")
	}
}
...
func callbackQXmlSimpleReader_Parse3(ptr unsafe.Pointer, input unsafe.Pointer, incremental C.char) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "parse3"); signal != nil {
...
func (ptr *QXmlSimpleReader) ConnectParse3(f func(input *QXmlInputSource, incremental bool) bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "parse3"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse3", func(input *QXmlInputSource, incremental bool) bool {
				signal.(func(*QXmlInputSource, bool) bool)(input, incremental)
				return f(input, incremental)
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parse3", f)
		}
	}
}
...
func (ptr *QXmlSimpleReader) DisconnectParse3() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "parse3")
	}
}
...
func callbackQXmlSimpleReader_ParseContinue(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "parseContinue"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func() bool)())))
	}
...
func (ptr *QXmlSimpleReader) ConnectParseContinue(f func() bool) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "parseContinue"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parseContinue", func() bool {
				signal.(func() bool)()
				return f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "parseContinue", f)
		}
	}
}
...
func (ptr *QXmlSimpleReader) DisconnectParseContinue() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "parseContinue")
	}
}
...
func (ptr *QXmlSimpleReader) ConnectSetFeature(f func(name string, enable bool)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "setFeature"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "setFeature", func(name string, enable bool) {
...
func (ptr *QXmlSimpleReader) SetFeature(name string, enable bool) {
	if ptr.Pointer() != nil {
		...
		C.QXmlSimpleReader_SetFeature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(enable))))
	}
}
...
func (ptr *QXmlSimpleReader) SetFeatureDefault(name string, enable bool) {
	if ptr.Pointer() != nil {
		...
		C.QXmlSimpleReader_SetFeatureDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(enable))))
	}
}
...
func (ptr *QXmlSimpleReader) SetProperty(name string, value unsafe.Pointer) {
	if ptr.Pointer() != nil {
		...
		C.QXmlSimpleReader_SetProperty(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, value)
	}
}
...
func (ptr *QXmlSimpleReader) SetPropertyDefault(name string, value unsafe.Pointer) {
	if ptr.Pointer() != nil {
		...
		C.QXmlSimpleReader_SetPropertyDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, value)
	}
}
...
func callbackQXmlSimpleReader_DestroyQXmlSimpleReader(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QXmlSimpleReader"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QXmlSimpleReader) ConnectDestroyQXmlSimpleReader(f func()) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(fmt.Sprint(ptr.Pointer()), "~QXmlSimpleReader"); signal != nil {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlSimpleReader", func() {
				signal.(func())()
				f()
			})
		} else {
			qt.ConnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlSimpleReader", f)
		}
	}
}
...
func (ptr *QXmlSimpleReader) DisconnectDestroyQXmlSimpleReader() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QXmlSimpleReader")
	}
}
...
func (ptr *QXmlSimpleReader) Feature(name string, ok bool) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_Feature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) FeatureDefault(name string, ok bool) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_FeatureDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) HasFeature(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_HasFeature(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) HasFeatureDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_HasFeatureDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) HasProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_HasProperty(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) HasPropertyDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QXmlSimpleReader_HasPropertyDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QXmlSimpleReader) Property(name string, ok bool) unsafe.Pointer {
	if ptr.Pointer() != nil {
		...
		return unsafe.Pointer(C.QXmlSimpleReader_Property(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))))
	}
	return nil
}
...
func (ptr *QXmlSimpleReader) PropertyDefault(name string, ok bool) unsafe.Pointer {
	if ptr.Pointer() != nil {
		...
		return unsafe.Pointer(C.QXmlSimpleReader_PropertyDefault(ptr.Pointer(), C.struct_QtXml_PackedString{nameC, C.longlong(len(name))}, C.char(int8(qt.GoBoolToInt(ok)))))
	}
	return nil
}
