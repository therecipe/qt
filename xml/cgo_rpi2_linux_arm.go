...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_XML_LIB -DQT_XMLPATTERNS_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtXml -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtXmlPatterns -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Xml -lQt5XmlPatterns -lQt5Core -lGLESv2 -lpthread
*/
import "C"
