...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_XMLPATTERNS_LIB -DQT_XML_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtXmlPatterns -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtXml
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi1/lib -lQt5Core -lQt5XmlPatterns -lQt5Xml -lGLESv2 -lpthread
*/
import "C"
