...
#cgo CXXFLAGS: -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_XMLPATTERNS_LIB -DQT_XML_LIB
...
#cgo CXXFLAGS: -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtCore -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtXmlPatterns -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtXml
...
#cgo LDFLAGS: -rdynamic -L/srv/mer/targets/SailfishOS-armv7hl/usr/lib -L/srv/mer/targets/SailfishOS-armv7hl/lib -lsailfishapp -lmdeclarativecache5 -lQt5Core -lQt5XmlPatterns -lQt5Xml -lGLESv2 -lpthread
*/
import "C"
