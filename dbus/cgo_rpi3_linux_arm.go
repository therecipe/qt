...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtDBus -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi3/lib -lQt5DBus -lQt5Core -lGLESv2 -lpthread
*/
import "C"
