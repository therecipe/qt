...
#cgo CPPFLAGS: -DQT_NO_DEBUG -DQT_DBUS_LIB -DQT_CORE_LIB
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/clang_64/mkspecs/macx-clang -F/usr/local/Qt5.6.0/5.6/clang_64/lib
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/clang_64/lib/QtDBus.framework/Headers -I/usr/local/Qt5.6.0/5.6/clang_64/lib/QtCore.framework/Headers
...
#cgo LDFLAGS: -F/usr/local/Qt5.6.0/5.6/clang_64/lib -framework QtDBus -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL
*/
import "C"
