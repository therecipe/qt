...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtNfc
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Core -lQt5Nfc -lGLESv2 -lpthread
*/
import "C"
