...
#cgo CPPFLAGS: -DDARWIN_NO_CARBON -DQT_NO_PRINTER -DQT_NO_PRINTDIALOG -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_GUI_LIB -DQT_WIDGETS_LIB -DQT_UITOOLS_LIB
...
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/ios/include/QtCore -I/usr/local/Qt5.6.0/5.6/ios/include/QtGui -I/usr/local/Qt5.6.0/5.6/ios/include/QtWidgets -I/usr/local/Qt5.6.0/5.6/ios/include/QtUiTools
