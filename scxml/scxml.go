...
func (ptr *QScxmlCompiler) SetFileName(fileName string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlCompiler_SetFileName(ptr.Pointer(), C.struct_QtScxml_PackedString{fileNameC, C.longlong(len(fileName))})
	}
}
...
func (ptr *QScxmlCppDataModel) DisconnectSetScxmlProperty() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setScxmlProperty")
	}
}
...
func (ptr *QScxmlCppDataModel) SetScxmlProperty(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlCppDataModel_SetScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func (ptr *QScxmlCppDataModel) SetScxmlPropertyDefault(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlCppDataModel_SetScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func callbackQScxmlCppDataModel_Setup(ptr unsafe.Pointer, initialDataValues C.struct_QtScxml_PackedList) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setup"); signal != nil {
...
func (ptr *QScxmlCppDataModel) DisconnectSetup() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setup")
	}
}
...
func callbackQScxmlCppDataModel_ScxmlProperty(ptr unsafe.Pointer, name C.struct_QtScxml_PackedString) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "scxmlProperty"); signal != nil {
...
func (ptr *QScxmlCppDataModel) DisconnectScxmlProperty() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "scxmlProperty")
	}
}
...
func (ptr *QScxmlCppDataModel) ScxmlProperty(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlCppDataModel_ScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
...
func (ptr *QScxmlCppDataModel) ScxmlPropertyDefault(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlCppDataModel_ScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func callbackQScxmlCppDataModel_HasScxmlProperty(ptr unsafe.Pointer, name C.struct_QtScxml_PackedString) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "hasScxmlProperty"); signal != nil {
...
func (ptr *QScxmlCppDataModel) DisconnectHasScxmlProperty() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "hasScxmlProperty")
	}
}
...
func (ptr *QScxmlCppDataModel) HasScxmlProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlCppDataModel_HasScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QScxmlCppDataModel) HasScxmlPropertyDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlCppDataModel_HasScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QScxmlCppDataModel) InState(stateName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlCppDataModel_InState(ptr.Pointer(), C.struct_QtScxml_PackedString{stateNameC, C.longlong(len(stateName))}) != 0
	}
	return false
}
...
func (ptr *QScxmlDataModel) SetScxmlProperty(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlDataModel_SetScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func callbackQScxmlDataModel_StateMachineChanged(ptr unsafe.Pointer, stateMachine unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "stateMachineChanged"); signal != nil {
...
func (ptr *QScxmlDataModel) DisconnectStateMachineChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "stateMachineChanged")
	}
}
...
func (ptr *QScxmlDataModel) ScxmlProperty(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlDataModel_ScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlDataModel) HasScxmlProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlDataModel_HasScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QScxmlDataModel) __setup_initialDataValues_atList(i string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlDataModel___setup_initialDataValues_atList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlDataModel) __setup_initialDataValues_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlDataModel___setup_initialDataValues_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{keyC, C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}
...
func (ptr *QScxmlDataModel) ____setup_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlDataModel_____setup_keyList_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))})
	}
}
...
func (ptr *QScxmlDynamicScxmlServiceFactory) DisconnectInvoke() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "invoke")
	}
}
...
func (ptr *QScxmlEcmaScriptDataModel) SetScxmlProperty(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlEcmaScriptDataModel_SetScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func (ptr *QScxmlEcmaScriptDataModel) SetScxmlPropertyDefault(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlEcmaScriptDataModel_SetScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func callbackQScxmlEcmaScriptDataModel_SetScxmlEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "setScxmlEvent"); signal != nil {
...
func (ptr *QScxmlEcmaScriptDataModel) DisconnectSetScxmlEvent() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "setScxmlEvent")
	}
}
...
func (ptr *QScxmlEcmaScriptDataModel) ScxmlProperty(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlEcmaScriptDataModel_ScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlEcmaScriptDataModel) ScxmlPropertyDefault(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlEcmaScriptDataModel_ScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlEcmaScriptDataModel) HasScxmlProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlEcmaScriptDataModel_HasScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QScxmlEcmaScriptDataModel) HasScxmlPropertyDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlEcmaScriptDataModel_HasScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func NewQScxmlError2(fileName string, line int, column int, description string) *QScxmlError {
	...
	var tmpValue = NewQScxmlErrorFromPointer(C.QScxmlError_NewQScxmlError2(C.struct_QtScxml_PackedString{fileNameC, C.longlong(len(fileName))}, C.int(int32(line)), C.int(int32(column)), C.struct_QtScxml_PackedString{descriptionC, C.longlong(len(description))}))
	runtime.SetFinalizer(tmpValue, (*QScxmlError).DestroyQScxmlError)
	return tmpValue
}
...
func (ptr *QScxmlEvent) SetErrorMessage(message string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetErrorMessage(ptr.Pointer(), C.struct_QtScxml_PackedString{messageC, C.longlong(len(message))})
	}
}
...
func (ptr *QScxmlEvent) SetInvokeId(invokeid string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetInvokeId(ptr.Pointer(), C.struct_QtScxml_PackedString{invokeidC, C.longlong(len(invokeid))})
	}
}
...
func (ptr *QScxmlEvent) SetName(name string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetName(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))})
	}
}
...
func (ptr *QScxmlEvent) SetOrigin(origin string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetOrigin(ptr.Pointer(), C.struct_QtScxml_PackedString{originC, C.longlong(len(origin))})
	}
}
...
func (ptr *QScxmlEvent) SetOriginType(origintype string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetOriginType(ptr.Pointer(), C.struct_QtScxml_PackedString{origintypeC, C.longlong(len(origintype))})
	}
}
...
func (ptr *QScxmlEvent) SetSendId(sendid string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlEvent_SetSendId(ptr.Pointer(), C.struct_QtScxml_PackedString{sendidC, C.longlong(len(sendid))})
	}
}
...
func callbackQScxmlInvokableService_PostEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "postEvent"); signal != nil {
		signal.(func(*QScxmlEvent))(NewQScxmlEventFromPointer(event))
	}
...
func (ptr *QScxmlInvokableService) DisconnectPostEvent() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "postEvent")
	}
}
...
func callbackQScxmlInvokableService_Id(ptr unsafe.Pointer) C.struct_QtScxml_PackedString {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "id"); signal != nil {
		...
		return C.struct_QtScxml_PackedString{C.CString(tempVal), C.longlong(len(tempVal))}
	}
	tempVal := ""
	return C.struct_QtScxml_PackedString{C.CString(tempVal), C.longlong(len(tempVal))}
}
...
func (ptr *QScxmlNullDataModel) SetScxmlProperty(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlNullDataModel_SetScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func (ptr *QScxmlNullDataModel) SetScxmlPropertyDefault(name string, value core.QVariant_ITF, context string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlNullDataModel_SetScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}, core.PointerFromQVariant(value), C.struct_QtScxml_PackedString{contextC, C.longlong(len(context))}) != 0
	}
	return false
}
...
func (ptr *QScxmlNullDataModel) ScxmlProperty(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlNullDataModel_ScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlNullDataModel) ScxmlPropertyDefault(name string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlNullDataModel_ScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlNullDataModel) HasScxmlProperty(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlNullDataModel_HasScxmlProperty(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func (ptr *QScxmlNullDataModel) HasScxmlPropertyDefault(name string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlNullDataModel_HasScxmlPropertyDefault(ptr.Pointer(), C.struct_QtScxml_PackedString{nameC, C.longlong(len(name))}) != 0
	}
	return false
}
...
func QScxmlStateMachine_FromData(data core.QIODevice_ITF, fileName string) *QScxmlStateMachine {
	...
	var tmpValue = NewQScxmlStateMachineFromPointer(C.QScxmlStateMachine_QScxmlStateMachine_FromData(core.PointerFromQIODevice(data), C.struct_QtScxml_PackedString{fileNameC, C.longlong(len(fileName))}))
	if !qt.ExistsSignal(fmt.Sprint(tmpValue.Pointer()), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
func QScxmlStateMachine_FromFile(fileName string) *QScxmlStateMachine {
	...
	var tmpValue = NewQScxmlStateMachineFromPointer(C.QScxmlStateMachine_QScxmlStateMachine_FromFile(C.struct_QtScxml_PackedString{fileNameC, C.longlong(len(fileName))}))
	if !qt.ExistsSignal(fmt.Sprint(tmpValue.Pointer()), "destroyed") {
		tmpValue.ConnectDestroyed(func(*core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
func callbackQScxmlStateMachine_Init(ptr unsafe.Pointer) C.char {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "init"); signal != nil {
		return C.char(int8(qt.GoBoolToInt(signal.(func() bool)())))
	}
...
func (ptr *QScxmlStateMachine) DisconnectInit() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "init")
	}
}
...
func (ptr *QScxmlStateMachine) CancelDelayedEvent(sendId string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_CancelDelayedEvent(ptr.Pointer(), C.struct_QtScxml_PackedString{sendIdC, C.longlong(len(sendId))})
	}
}
...
func callbackQScxmlStateMachine_DataModelChanged(ptr unsafe.Pointer, model unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "dataModelChanged"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectDataModelChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "dataModelChanged")
	}
}
...
func callbackQScxmlStateMachine_InitializedChanged(ptr unsafe.Pointer, initialized C.char) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "initializedChanged"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectInitializedChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "initializedChanged")
	}
}
...
func callbackQScxmlStateMachine_InvokedServicesChanged(ptr unsafe.Pointer, invokedServices C.struct_QtScxml_PackedList) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "invokedServicesChanged"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectInvokedServicesChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "invokedServicesChanged")
	}
}
...
func callbackQScxmlStateMachine_Log(ptr unsafe.Pointer, label C.struct_QtScxml_PackedString, msg C.struct_QtScxml_PackedString) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "log"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectLog() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "log")
	}
}
...
func (ptr *QScxmlStateMachine) Log(label string, msg string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_Log(ptr.Pointer(), C.struct_QtScxml_PackedString{labelC, C.longlong(len(label))}, C.struct_QtScxml_PackedString{msgC, C.longlong(len(msg))})
	}
}
...
func callbackQScxmlStateMachine_ReachedStableState(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "reachedStableState"); signal != nil {
		signal.(func())()
	}
...
func (ptr *QScxmlStateMachine) DisconnectReachedStableState() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "reachedStableState")
	}
}
...
func callbackQScxmlStateMachine_RunningChanged(ptr unsafe.Pointer, running C.char) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "runningChanged"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectRunningChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "runningChanged")
	}
}
...
func (ptr *QScxmlStateMachine) SubmitEvent2(eventName string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_SubmitEvent2(ptr.Pointer(), C.struct_QtScxml_PackedString{eventNameC, C.longlong(len(eventName))})
	}
}
...
func (ptr *QScxmlStateMachine) SubmitEvent3(eventName string, data core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_SubmitEvent3(ptr.Pointer(), C.struct_QtScxml_PackedString{eventNameC, C.longlong(len(eventName))}, core.PointerFromQVariant(data))
	}
}
...
func callbackQScxmlStateMachine_TableDataChanged(ptr unsafe.Pointer, tableData unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "tableDataChanged"); signal != nil {
...
func (ptr *QScxmlStateMachine) DisconnectTableDataChanged() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "tableDataChanged")
	}
}
...
func (ptr *QScxmlStateMachine) IsActive(scxmlStateName string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlStateMachine_IsActive(ptr.Pointer(), C.struct_QtScxml_PackedString{scxmlStateNameC, C.longlong(len(scxmlStateName))}) != 0
	}
	return false
}
...
func (ptr *QScxmlStateMachine) IsDispatchableTarget(target string) bool {
	if ptr.Pointer() != nil {
		...
		return C.QScxmlStateMachine_IsDispatchableTarget(ptr.Pointer(), C.struct_QtScxml_PackedString{targetC, C.longlong(len(target))}) != 0
	}
	return false
}
...
func (ptr *QScxmlStateMachine) __initialValues_atList(i string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlStateMachine___initialValues_atList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlStateMachine) __initialValues_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine___initialValues_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{keyC, C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}
...
func (ptr *QScxmlStateMachine) __initialValuesChanged_initialValues_atList(i string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlStateMachine___initialValuesChanged_initialValues_atList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlStateMachine) __initialValuesChanged_initialValues_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine___initialValuesChanged_initialValues_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{keyC, C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}
...
func (ptr *QScxmlStateMachine) __setInitialValues_initialValues_atList(i string) *core.QVariant {
	if ptr.Pointer() != nil {
		...
		var tmpValue = core.NewQVariantFromPointer(C.QScxmlStateMachine___setInitialValues_initialValues_atList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))}))
		runtime.SetFinalizer(tmpValue, (*core.QVariant).DestroyQVariant)
		return tmpValue
	}
	return nil
...
func (ptr *QScxmlStateMachine) __setInitialValues_initialValues_setList(key string, i core.QVariant_ITF) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine___setInitialValues_initialValues_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{keyC, C.longlong(len(key))}, core.PointerFromQVariant(i))
	}
}
...
func (ptr *QScxmlStateMachine) ____initialValues_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_____initialValues_keyList_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))})
	}
}
...
func (ptr *QScxmlStateMachine) ____initialValuesChanged_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_____initialValuesChanged_keyList_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))})
	}
}
...
func (ptr *QScxmlStateMachine) ____setInitialValues_keyList_setList(i string) {
	if ptr.Pointer() != nil {
		...
		C.QScxmlStateMachine_____setInitialValues_keyList_setList(ptr.Pointer(), C.struct_QtScxml_PackedString{iC, C.longlong(len(i))})
	}
}
...
func callbackQScxmlTableData_DestroyQScxmlTableData(ptr unsafe.Pointer) {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "~QScxmlTableData"); signal != nil {
		signal.(func())()
	} else {
...
func (ptr *QScxmlTableData) DisconnectDestroyQScxmlTableData() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "~QScxmlTableData")
	}
}
...
func callbackQScxmlTableData_ServiceFactory(ptr unsafe.Pointer, id C.int) unsafe.Pointer {
	if signal := qt.GetSignal(fmt.Sprint(ptr), "serviceFactory"); signal != nil {
...
func (ptr *QScxmlTableData) DisconnectServiceFactory() {
	if ptr.Pointer() != nil {
		...
		qt.DisconnectSignal(fmt.Sprint(ptr.Pointer()), "serviceFactory")
	}
}
