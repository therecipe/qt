...
;
;
struct QtScxml_PackedString QScxmlCppDataModel_EvaluateToString(void* ptr, long long id, char ok);
char QScxmlCppDataModel_EvaluateToBool(void* ptr, long long id, char ok);
void* QScxmlCppDataModel_EvaluateToVariant(void* ptr, long long id, char ok);
void QScxmlCppDataModel_EvaluateToVoid(void* ptr, long long id, char ok);
void QScxmlCppDataModel_EvaluateAssignment(void* ptr, long long id, char ok);
void QScxmlCppDataModel_EvaluateInitialization(void* ptr, long long id, char ok);
;
