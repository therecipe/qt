...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_WEBCHANNEL_LIB -DQT_WIDGETS_LIB -DQT_WEBENGINECORE_LIB -DQT_WEBENGINEWIDGETS_LIB -DQT_WEBENGINE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebChannel -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngineCore -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngineWidgets -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngine
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi3/lib -lQt5Core -lQt5Gui -lQt5Network -lQt5WebChannel -lQt5Widgets -lQt5WebEngineCore -lQt5WebEngineWidgets -lQt5WebEngine -lGLESv2 -lpthread
*/
import "C"
