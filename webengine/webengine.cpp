...
{
	return ({ QByteArray tef81e2 = static_cast<QWebEngineProfile*>(ptr)->downloadPath().toUtf8(); QtWebEngine_PackedString { const_cast<char*>(tef81e2.prepend("WHITESPACE").constData()+10), tef81e2.size()-10 }; });
}
