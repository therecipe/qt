...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngine -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngineWidgets -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebChannel -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtWebEngineCore -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtQuick -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtQml -I/usr/local/Qt5.7.0/5.7/rpi3/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi3/lib -lQt5WebEngine -lQt5Widgets -lQt5WebEngineWidgets -lQt5WebChannel -lQt5Network -lQt5WebEngineCore -lQt5Quick -lQt5Gui -lQt5Qml -lQt5Core -lGLESv2 -lpthread
*/
import "C"
