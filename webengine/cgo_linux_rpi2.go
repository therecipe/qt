...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWebChannel -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWebEngineCore -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWebEngineWidgets -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWebEngine
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Core -lQt5Gui -lQt5Network -lQt5WebChannel -lQt5Widgets -lQt5WebEngineCore -lQt5WebEngineWidgets -lQt5WebEngine -lGLESv2 -lpthread
*/
import "C"
