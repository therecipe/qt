...
public:
	...
	QList<QNetworkCookie> cookiesForUrl(const QUrl & url) const { return *static_cast<QList<QNetworkCookie>*>(callbackQNetworkCookieJar_CookiesForUrl(const_cast<void*>(static_cast<const void*>(this)), const_cast<QUrl*>(&url))); };
