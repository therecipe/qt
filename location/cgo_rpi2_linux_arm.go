...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_LOCATION_LIB -DQT_POSITIONING_LIB -DQT_QUICK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtLocation -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtPositioning -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtQuick -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Location -lQt5Positioning -lQt5Quick -lQt5Gui -lQt5Core -lGLESv2 -lpthread
*/
import "C"
