...
#cgo CXXFLAGS: -DQT_NO_DEBUG -DQT_LOCATION_LIB -DQT_QUICK_LIB -DQT_QML_LIB -DQT_POSITIONING_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/clang_64/mkspecs/macx-clang -F/usr/local/Qt5.7.0/5.7/clang_64/lib
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtLocation.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtQuick.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtQml.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtPositioning.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtNetwork.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtGui.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtCore.framework/Headers
...
#cgo LDFLAGS: -F/usr/local/Qt5.7.0/5.7/clang_64/lib -framework QtLocation -framework QtQuick -framework QtQml -framework QtPositioning -framework QtNetwork -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL
*/
import "C"
