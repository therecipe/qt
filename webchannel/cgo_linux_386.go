...
#cgo CPPFLAGS: -I/usr/local/Qt5.5.1/5.5/gcc/include/QtCore -I/usr/local/Qt5.5.1/5.5/gcc/include/QtNetwork -I/usr/local/Qt5.5.1/5.5/gcc/include/QtQml -I/usr/local/Qt5.5.1/5.5/gcc/include/QtWebChannel

#cgo LDFLAGS: -Wl,-O1 -Wl,-rpath,/usr/local/Qt5.5.1/5.5/gcc -Wl,-rpath,/usr/local/Qt5.5.1/5.5/gcc/lib
#cgo LDFLAGS: -L/usr/local/Qt5.5.1/5.5/gcc/lib -L/usr/lib -lQt5Core -lQt5Network -lQt5Qml -lQt5WebChannel -lpthread
*/
import "C"
