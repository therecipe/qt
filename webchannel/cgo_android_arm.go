...
#cgo CPPFLAGS: -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtCore -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtNetwork -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtQml -I/usr/local/Qt5.5.1/5.5/android_armv7/include/QtWebChannel
...
#cgo LDFLAGS: -L/opt/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a -L/opt/android-ndk/platforms/android-9/arch-arm//usr/lib -L/usr/local/Qt5.5.1/5.5/android_armv7/lib -L/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a -L/opt/android/ndk/platforms/android-9/arch-arm//usr/lib -lQt5Core -lQt5Network -lQt5Qml -lQt5WebChannel -lGLESv2 -lgnustl_shared -llog -lz -lm -ldl -lc -lgcc
*/
import "C"
