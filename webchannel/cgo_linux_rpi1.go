...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtCore -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtQml -I/usr/local/Qt5.7.0/5.7/rpi1/include/QtWebChannel
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi1/lib -lQt5Core -lQt5Network -lQt5Qml -lQt5WebChannel -lGLESv2 -lpthread
*/
import "C"
