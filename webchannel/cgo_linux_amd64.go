...
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/gcc_64/include/QtCore -I/usr/local/Qt5.6.0/5.6/gcc_64/include/QtNetwork -I/usr/local/Qt5.6.0/5.6/gcc_64/include/QtQml -I/usr/local/Qt5.6.0/5.6/gcc_64/include/QtWebChannel

#cgo LDFLAGS: -Wl,-O1 -Wl,-rpath,/usr/local/Qt5.6.0/5.6/gcc_64 -Wl,-rpath,/usr/local/Qt5.6.0/5.6/gcc_64/lib
#cgo LDFLAGS: -L/usr/local/Qt5.6.0/5.6/gcc_64/lib -L/usr/lib64 -lQt5Core -lQt5Network -lQt5Qml -lQt5WebChannel -lpthread
*/
import "C"
