...
#cgo CXXFLAGS: -DQT_NO_DEBUG -DQT_SENSORS_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtSensors -I/srv/mer/targets/SailfishOS-armv7hl/usr/include/qt5/QtCore
...
#cgo LDFLAGS: -rdynamic -L/srv/mer/targets/SailfishOS-armv7hl/usr/lib -L/srv/mer/targets/SailfishOS-armv7hl/lib -lsailfishapp -lmdeclarativecache5 -lQt5Sensors -lQt5Core -lGLESv2 -lpthread
*/
import "C"
