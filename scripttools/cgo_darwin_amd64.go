...
#cgo LDFLAGS: -F/usr/local/Qt5.5.1/5.5/clang_64/lib -framework QtCore -framework QtGui -framework QtScript -framework QtWidgets -framework QtScriptTools -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL
*/
import "C"
