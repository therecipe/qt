...
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/ios/include/QtCore -I/usr/local/Qt5.6.0/5.6/ios/include/QtGui -I/usr/local/Qt5.6.0/5.6/ios/include/QtScript -I/usr/local/Qt5.6.0/5.6/ios/include/QtWidgets -I/usr/local/Qt5.6.0/5.6/ios/include/QtScriptTools

#cgo LDFLAGS: -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.3.sdk -miphoneos-version-min=6.1 -arch armv7
#cgo LDFLAGS: -L/usr/local/Qt5.6.0/5.6/ios/plugins/platforms -lqios -framework Foundation -framework UIKit -framework QuartzCore -framework AssetsLibrary -L/usr/local/Qt5.6.0/5.6/ios/lib -framework MobileCoreServices -framework CoreFoundation -framework CoreText -framework CoreGraphics -framework OpenGLES -lqtfreetype -framework Security -framework SystemConfiguration -framework CoreBluetooth -L/usr/local/Qt5.6.0/5.6/ios/plugins/imageformats -lqdds -lqicns -lqico -lqtga -lqtiff -lqwbmp -lqwebp -lqtharfbuzzng -lz -lqtpcre -lm -lQt5Core -lQt5Gui -lQt5Script -lQt5Widgets -lQt5ScriptTools -lQt5PlatformSupport
*/
import "C"
