...
#cgo CXXFLAGS: -DQT_NO_DEBUG -DQT_SCRIPTTOOLS_LIB -DQT_SCRIPT_LIB -DQT_WIDGETS_LIB -DQT_CORE_LIB
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/clang_64/mkspecs/macx-clang -F/usr/local/Qt5.7.0/5.7/clang_64/lib
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtScriptTools.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtScript.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtWidgets.framework/Headers -I/usr/local/Qt5.7.0/5.7/clang_64/lib/QtCore.framework/Headers
...
#cgo LDFLAGS: -F/usr/local/Qt5.7.0/5.7/clang_64/lib -framework QtScriptTools -framework QtScript -framework QtWidgets -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL
*/
import "C"
