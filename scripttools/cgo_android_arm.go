...
#cgo CPPFLAGS: -I/usr/local/Qt5.6.0/5.6/android_armv7/include/QtScriptTools -I/usr/local/Qt5.6.0/5.6/android_armv7/include/QtWidgets -I/usr/local/Qt5.6.0/5.6/android_armv7/include/QtScript -I/usr/local/Qt5.6.0/5.6/android_armv7/include/QtGui -I/usr/local/Qt5.6.0/5.6/android_armv7/include/QtCore
...
#cgo LDFLAGS: -L/opt/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a -L/opt/android-ndk/platforms/android-9/arch-arm//usr/lib -L/usr/local/Qt5.6.0/5.6/android_armv7/lib -L/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a -L/opt/android/ndk/platforms/android-9/arch-arm//usr/lib -lQt5ScriptTools -lQt5Widgets -lQt5Script -lQt5Gui -lQt5Core -lGLESv2 -lgnustl_shared -llog -lz -lm -ldl -lc -lgcc
*/
import "C"
