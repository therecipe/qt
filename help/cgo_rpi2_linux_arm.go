...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_HELP_LIB -DQT_SQL_LIB -DQT_CLUCENE_LIB -DQT_NETWORK_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtHelp -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtSql -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCLucene -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Help -lQt5Sql -lQt5CLucene -lQt5Network -lQt5Widgets -lQt5Gui -lQt5Core -lGLESv2 -lpthread
*/
import "C"
