...
#cgo LDFLAGS: -rdynamic -L/srv/mer/targets/SailfishOS-i486/usr/lib -L/srv/mer/targets/SailfishOS-i486/lib -lsailfishapp -lmdeclarativecache5 -lQt5Core -lQt5Gui -lQt5Network -lQt5Qml -lQt5Quick -lGLESv2 -lpthread
*/
import "C"
