...
#cgo LDFLAGS: -F/usr/local/Qt5.5.1/5.5/clang_64/lib -framework QtCore -framework QtGui -framework QtNetwork -framework QtQml -framework QtQuick -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL
*/
import "C"
