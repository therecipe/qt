...
#cgo CXXFLAGS: -DQT_NO_EXCEPTIONS -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -DQT_NO_DEBUG -DQT_QUICK_LIB -DQT_QUICKWIDGETS_LIB -DQT_WIDGETS_LIB -DQT_NETWORK_LIB -DQT_QML_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
#cgo CXXFLAGS: -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtQuick -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtQuickWidgets -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtWidgets -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtNetwork -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtQml -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtGui -I/usr/local/Qt5.7.0/5.7/rpi2/include/QtCore
...
#cgo LDFLAGS: -L/home/user/raspi/sysroot/opt/vc/lib -L/usr/local/Qt5.7.0/5.7/rpi2/lib -lQt5Quick -lQt5QuickWidgets -lQt5Widgets -lQt5Network -lQt5Qml -lQt5Gui -lQt5Core -lGLESv2 -lpthread
*/
import "C"
